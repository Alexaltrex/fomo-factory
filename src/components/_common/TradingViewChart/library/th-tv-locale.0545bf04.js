...
_tv_languages.th = {
    ...
    "Move the point to position the anchor then tap to place":
        "ย้ายจุดมายังตำแหน่ง anchor แล้วแตะเพื่อวาง",
    ...
    "Press and hold {key} while zooming to maintain the chart position":
        "กดและค้าง {key} ขณะซูมเพื่อคงตำแหน่งของชาร์ต",
    "Double-click any edge to reset layout grid":
        "คลิกสองครั้งที่ขอบใดก็ได้เพื่อรีเซ็ตเส้นตารางเลย์เอาต์",
    "Link to the chart image copied to clipboard {emoji}":
        "ลิงก์ไปยังรูปภาพชาร์ตที่คัดลอกไปยังคลิปบอร์ดแล้ว {emoji}",
    "Chart image copied to clipboard {emoji}":
        "คัดลอกรูปภาพชาร์ตไปยังคลิปบอร์ดแล้ว {emoji}",
    Baseline: "เส้นฐาน",
    Units: "หน่วย",
    Reverse: "ย้อนกลับ",
    Yes: "ใช่",
    ...
    "Specified value is more than the instrument maximum of {max}.":
        "ค่าที่ระบุมากกว่าค่าสูงสุดของเครื่องมือ {max}",
    "Specified value is less than the instrument minimum of {min}.":
        "ค่าที่ระบุน้อยกว่าค่าต่ำสุดของเครื่องมือ {min}",
    Risk: "ความเสี่ยง",
    Body: "บอดี้",
    Wick: "ไส้เทียน",
    Right: "ขวา",
    ...
    "Color bars based on previous close":
        "สีของ Bars อ้างอิงจากราคาปิดครั้งก่อน",
    Borders: "เส้นขอบ",
    ...
    "You cannot see this pivot timeframe on this resolution":
        "ท่านไม่สามารถดูกรอบเวลานี้บนความละเอียดจออันนี้ได้",
    ...
    "use settlement as close on daily interval":
        "ใช้การชำระราคาที่ใกล้เคียงกันในแต่ละวัน",
    ext: "ต่อ",
    ...
    "Main symbol data is adjusted for dividends only":
        "ข้อมูลสัญลักษณ์หลักถูกปรับเป็นเงินปันผลเท่านั้น",
    "Main symbol data is adjusted for splits only":
        "ข้อมูลสัญลักษณ์หลักถูกปรับสำหรับการแยกเท่านั้น",
    ...
    "change continuous contract switch visibility":
        "เปลี่ยนการมองเห็นสวิตช์สัญญาต่อเนื่อง",
    ...
    "add this indicator to entire layout":
        "เพิ่มอินดิเคเตอร์นี้เข้าไปในเลย์เอาท์ทั้งหมด",
    ...
    "Add indicator/strategy on {studyTitle}":
        "เพิ่มอินดิเคเตอร์/กลยุทธ์ที่ {studyTitle}",
    "Add financial metric for {instrumentName}":
        "เพิ่มตัวชี้วัดทางการเงินสำหรับ {instrumentName}",
    ...
    "change pre/post market price label visibility":
        "เปลี่ยนการมองเห็นป้ายราคาตลาดก่อน/หลัง",
    "change high and low price lines visibility":
        "เปลี่ยนการมองเห็นเส้นราคาสูง ต่ำ และเฉลี่ย",
    "change high and low price labels visibility":
        "เปลี่ยนการมองเห็นป้ายราคาสูง ต่ำ และเฉลี่ย",
    "change countdown to bar close visibility":
        "เปลี่ยนการนับถอยหลังเป็นบาร์ปิดการมองเห็น",
    ...
    "Symbol previous day close price label":
        "ป้ายค่าราคาปิดวันก่อนหน้าของตัวย่อ",
    ...
    "Indicators and financials value labels":
        "อินดิเคเตอร์และฉลากมูลค่าทางการเงิน",
    ...
    "change symbol description visibility":
        "เปลี่ยนการมองเห็นคำอธิบายสัญลักษณ์",
    ...
    "change indicator arguments visibility":
        "เปลี่ยนการมองเห็นอาร์กิวเมนต์อินดิเคเตอร์",
    ...
    "{hotKey_0} — drawing a straight line at angles of 45":
        "{hotKey_0} — วาดเส้นตรง 1 เส้นที่ทำมุม 45 องศา",
    ...
    "change {title} visibility on seconds":
        "เปลี่ยนการมองเห็น {title} เป็นวินาที",
    ...
    "change {title} visibility on minutes":
        "เปลี่ยนการมองเห็น {title} เป็นนาที",
    ...
    "change {title} visibility on hours":
        "เปลี่ยนการมองเห็น {title} เป็นชั่วโมง",
    ...
    "change {title} visibility on weeks":
        "เปลี่ยนการมองเห็น {title} เป็นสัปดาห์",
    ...
    "change {title} visibility on months":
        "เปลี่ยนการมองเห็น {title} เป็นเดือน",
    ...
    "change currency and unit labels visibility":
        "เปลี่ยนสกุลเงินและการมองเห็นป้ายหน่วย",
    ...
    "change color bars based on previous close":
        "เปลี่ยนสีแท่งของราคาปิดในวันก่อนหน้า",
    ...
    "change baseline fill bottom area color":
        "เปลี่ยนสีพื้นที่ใต้เส้นฐานด้านล่าง",
    ...
    "change {candleType} border visibility":
        "เปลี่ยนการมองเห็นเส้นขอบ {candleType}",
    "change {candleType} up border color":
        "เปลี่ยนสีเส้นขอบ {candleType} ขาขึ้น",
    "change {candleType} down border color":
        "เปลี่ยนสีเส้นขอบ {candleType} ขาลง",
    "change {candleType} wick visibility":
        "เปลี่ยนการมองเห็นไส้เทียน {candleType}",
    "change {candleType} wick up color":
        "เปลี่ยนสีไส้เทียน {candleType} ขาขึ้น",
    "change {candleType} wick down color":
        "เปลี่ยนสีไส้เทียน {candleType} ขาลง",
    ...
    "change {chartType} projection bar up color":
        "เปลี่ยนสี {chartType} แท่งคาดคะเนขาขึ้น",
    "change {chartType} projection bar down color":
        "เปลี่ยนสี {chartType} แท่งคาดคะเนขาลง",
    "change {chartType} border bar up color":
        "เปลี่ยนสีเส้นขอบ {chartType} แท่งขาขึ้น",
    "change {chartType} border bar down color":
        "เปลี่ยนสีเส้นขอบ {chartType} แท่งขาลง",
    "change {chartType} projection border bar up color":
        "เปลี่ยนสีเส้นขอบ {chartType} แท่งคาดคะเนขาขึ้น",
    ...
    "Real prices on price scale (instead of Heikin-Ashi price)":
        "ราคาจริงในระดับราคา (แทนที่ราคา Heikin-Ashi)",
    "Base level": "ระดับฐาน",
    candle: "แท่งเทียน",
    range_0: "ช่วง",
    "hollow candles": "แท่งเทียนแบบกลวง",
    ...
    "change {title} middle point visibility":
        "เปลี่ยนการมองเห็น {title} จุดกึ่งกลาง",
    "change {title} price labels visibility":
        "เปลี่ยนการมองเห็น {title} ป้ายราคา",
    "change {title} price range visibility":
        "เปลี่ยนการมองเห็น {title} ช่วงราคา",
    "change {title} bars range visibility":
        "เปลี่ยนการมองเห็น {title} ช่วงระยะแท่ง",
    "change {title} date/time range visibility":
        "เปลี่ยนการมองเห็น {title} ช่วงวัน/เวลา",
    ...
    "change {toolName} line extending right":
        "เปลี่ยน {toolName} ขยายเส้นทางขวา",
    ...
    "change {title} background visibility":
        "เปลี่ยนการมองเห็น {title} พื้นหลัง",
    ...
    "change {title} full circles visibility":
        "เปลี่ยนการมองเห็น {title} วงกลมเต็ม",
    "Full circles": "เต็มวงกลม",
    "change {title} left labels visibility":
        "เปลี่ยนการมองเห็น {title} ป้ายกำกับด้านซ้าย",
    "change {title} right labels visibility":
        "เปลี่ยนการมองเห็น {title} ป้ายกำกับด้านขวา",
    "change {title} top labels visibility":
        "เปลี่ยนการมองเห็น {title} ป้ายกำกับด้านบน",
    "change {title} bottom labels visibility":
        "เปลี่ยนการมองเห็น {title} ป้ายกำกับด้านล่าง",
    ...
    "change {title} level {index} line style":
        "เปลี่ยนรูปแบบเส้น {title} ระดับ {index}",
    ...
    "change {title} fan {index} line visibility":
        "เปลี่ยนการมองเห็น {title} เส้นแฟน {index}",
    "change {title} fan {index} line color":
        "เปลี่ยนสี {title} เส้นแฟน {index}",
    "change {title} fan {index} line width":
        "เปลี่ยนความกว้าง {title} เส้นแฟน {index}",
    "change {title} arcs {index} line visibility":
        "เปลี่ยนการมองเห็น {title} เส้นอาร์ค {index}",
    "change {title} arcs {index} line color":
        "เปลี่ยนสี {title} เส้นอาร์ค {index}",
    "change {title} arcs {index} line width":
        "เปลี่ยนความกว้าง {title} เส้นอาร์ค {index}",
    ...
    "change {title} candle border visibility":
        "เปลี่ยนการมองเห็น {title} เส้นขอบแท่งเทียน",
    "change {title} candle border up color":
        "เปลี่ยนสีเส้นขอบ {title} แท่งเทียนขาขึ้น",
    "change {title} candle border down color":
        "เปลี่ยนสีเส้นขอบ {title} แท่งเทียนขาลง",
    "change {title} candle wick visibility":
        "เปลี่ยนการมองเห็น {title} ไส้เทียน",
    ...
    "change {title} source background color":
        "เปลี่ยนสีพื้นหลัง {title} ต้นฉบับ",
    ...
    "change {title} target background color":
        "เปลี่ยนสีพื้นหลัง {title} เป้าหมาย",
    ...
    "change previous close price line width":
        "เปลี่ยนความกว้างเส้นราคาปิดก่อนหน้า",
    "change pre/post market price lines visibility":
        "เปลี่ยนการมองเห็นเส้นราคาตลาดก่อน/หลัง",
    ...
    "change {title} base line visibility":
        "เปลี่ยนการมองเห็น {title} เส้นพื้นฐาน",
    ...
    "change {title} show pearson's r":
        "เปลี่ยน {title} การแสดงผลเพียร์สัน อาร์",
    Base: "ฐาน",
    Up: "บน",
    Down: "ทิศลง",
    ...
    "{symbolName} data is delayed by {time} minutes.":
        "ข้อมูล {symbolName} ดีเลย์ {time} นาที",
    ...
    "All's well — Market is open.":
        "ทุกอย่างเป็นไปได้ด้วยดี — ตลาดเปิดทำการอยู่",
    "Morning. Market is open for pre-market trading.":
        "ตอนเช้า ตลาดเปิดอยู่สำหรับการเทรดแบบก่อนตลาดเปิดเท่านั้น",
    "Evening. Market is open for post-market trading.":
        "ตอนค่ำ ตลาดเปิดอยู่สำหรับการเทรดหลังตลาดปิดเท่านั้น",
    "Time for a walk — this market is closed.":
        "ได้เวลาไปเดินเล่น — ตลาดนี้ได้ปิดลงแล้ว",
    "Market is currently on holiday. Lucky them.":
        "ขณะนี้ตลาดอยู่ในช่วงวันหยุด โชคดีจัง",
    ...
    "It'll go to post-market trading in {remainingTime}.":
        "จะเข้าสู่การซื้อขายหลังเวลาทำการใน {remainingTime}",
    "It'll open for pre-market trading in {remainingTime}.":
        "จะเปิดให้ซื้อขายล่วงหน้าใน {remainingTime}",
    ...
    "Do you really want to delete Study Template '{name}' ?":
        "คุณต้องการลบเทมเพลตการศึกษา'{name}'จริงๆ หรือไม่?",
    ...
    "remove all studies and drawing tools":
        "ลบการศึกษาและเครื่องมือวาดภาพทั้งหมด",
    ...
    "rename group {group} to {newName}":
        "เปลี่ยนชื่อกรุ๊ปจาก {group} เป็น {newName}",
    "change {sourceTitle} title to {newSourceTitle}":
        "เปลี่ยนชื่อ {sourceTitle} ไปเป็น {newSourceTitle}",
    ...
    "Fundamental studies are no longer available on charts":
        "เครื่องมือทางพื้นฐานไม่ได้ให้บริการบนกราฟแล้ว",
    "loading...": "กำลังโหลด....",
    ...
    "exclude line tools from group {group}":
        "ไม่รวมเครื่องมือเส้นจากกรุ๊ป {group}",
    ...
    "Do you really want to delete study and all of it's children?":
        "คุณต้องการที่จะลบการศึกษาและรวมถึงของเด็กทั้งหมด?",
    ...
    "Do you really want to delete Color Theme '{name}' ?":
        "คุณต้องการลบธีมสี'{name}'จริง ๆหรือไม่ ?",
    Normal: "ปกติ",
    "Dashed line": "เส้นประ",
    ...
    "No symbols here yet — why not add some?":
        "ยังไม่มีสัญลักษณ์ - ทำไมไม่เพิ่มมันบ้างล่ะ?",
    ...
    "Drawing is hidden on current interval":
        "การวาดถูกซ่อนไว้สำหรับช่วงเวลาปัจจุบัน",
    ...
    'Set the time and price for "{studyShortDescription}"':
        'ตั้งเวลาและราคาสำหรับ "{studyShortDescription}"',
    'Set the "{inputTitle}" time for "{studyShortDescription}"':
        "กำหนดเวลา {inputTitle} สำหรับ {studyShortDescription}",
    'Set the time for "{studyShortDescription}"':
        'ตั้งเวลาสำหรับ "{studyShortDescription}"',
    'Set the "{inputTitle}" price for "{studyShortDescription}"':
        "กำหนดราคา {inputTitle} สำหรับ {studyShortDescription}",
    'Set the price for "{studyShortDescription}"':
        'กำหนดราคาสำหรับ "{studyShortDescription}"',
    ...
    "apply factory defaults to selected sources":
        "ใช้ค่าเริ่มต้นจากโรงงานกับแหล่งที่เลือก",
    ...
    "Please enter the right date format yyyy-mm-dd":
        "กรุณาใส่วันที่ถูกตัองในรูปแบบ ปี-เดือน-วัน",
