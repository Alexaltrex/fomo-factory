...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
    [7271],
    {
                ...
                includes(e) {
                    return (function (e, t) {
                        ...
                        return (
                            ...
                            (void 0 !== r &&
                                r.some((e) => e.toLowerCase().includes(s)))
                        );
                    })(this._exchange, e);
                }
        ...
        43900: (e, t, s) => {
            ...
            function _(e) {
                return (
                    e instanceof d.study_Overlay || e instanceof h.StudyCompare
                );
            }
            function p(e, t, s) {
            ...
            class v {
                constructor(e) {
                    (this._contentItemList = new (a())([])),
                        ...
                        (this.removeStudy = (e) => {
                            ...
                            o && o.length > 1
                                ? this._removeStudyIdFromCheckedSymbols(
                                      t,
                                      s.id()
                                  )
                        ...
                        (this._getResolveSymbolPromise = (e, t) =>
                            new Promise((s) => {
                                const n = (0, o.ensureNotNull)(
                                    ...
                                    (0,
                                    i.encodeExtendedSymbolOrGetSimpleSymbolString)(
                                        { symbol: e }
                                    ),
                                    s
                                );
                        ...
                        d = l.map((e) => {
                            ...
                            if (t)
                                return Promise.resolve(
                                    u.QualifiedSources.fromSymbolInfo(t)
                                );
                            const s = e.symbol();
                    ...
                    Promise.all(d).then((e) => {
                            ...
                            (e = []),
                                this._chartWidget.compareSymbols() &&
                                    this._chartWidget
                                        ...
                                        .forEach((t) => {
                                            e.push(
                                                (0, u.qualifyProName)(t.symbol)
                                            ),
                                                this._defaultSymbolsDescriptions.set(
                                                    t.symbol,
                                                    t.title
                                                );
                                        });
                        ...
                        const i = Array.from(new Set(n));
                        {
                            const e = new Map(),
                                t = i.map((t) =>
                                    this._getResolveSymbolPromise(t, e)
                                );
                            Promise.all(t).then((t) =>
                                this._handleInitProcess(
                                    ...
                                    (e, t) =>
                                        u.QualifiedSources.fromSymbolMessage(
                                            t,
                                            e
                                        ),
                                    (e, t, s, o) =>
                ...
                handleSourcesChange() {
                    ...
                    Array.from(t).forEach((e) => {
                        if (!this._checkedStudiesIds().has(e)) {
                            const t =
                                this.chartModel().dataSourceForId(e) || null;
                            if (null !== t && _(t)) {
                ...
                applyStudy(e, t, s) {
                    ...
                    Promise.all([this._getResolveSymbolPromise(e), n]).then(
                        (t) =>
                            this._handleApplyProcess(
                                t,
                                (t) =>
                                    u.QualifiedSources.fromSymbolMessage(e, t),
                                (e, t, s) =>
                                    "symbol_resolved" === e.method
                                        ? p(e.params[1], !0, s)
                                        : f(t, !0, s)
                ...
                _handleInitProcess(e, t, s, o) {
                    ...
                    for (const r of e) {
                        ...
                        if (void 0 === c || a)
                            ...
                            for (const t of c)
                                n.push(o(e, i, !0, this._idToStudyMap.get(t)));
                    }
                    this._updateContentItemList(n),
                        this._isDataReady.setValue(!0);
                }
                _showNewItem(e, t, s) {
                    ...
                    o.unshift(e),
                        ...
                        setTimeout(
                            () => this._highlightedSymbol.setValue(null),
                            500
                        );
                }
                ...
                _updateChecked(e) {
                    ...
                    const s = this._checkedSymbols.get(e.symbol),
                        o =
                            null === (t = e.study) || void 0 === t
                                ? void 0
                                : t.id();
                    return o
                        ? { ...e, checked: Boolean(s && s.includes(o)) }
                        : e;
                }
                ...
                _checkedStudiesIds() {
                    const e = [].concat(
                        ...Array.from(this._checkedSymbols.values())
                    );
                    return new Set(e);
                }
                ...
                _loadRecent() {
                    return this._recentSymbolsEnabled
                        ? b.getJSON("CompareDialog.recent", [])
                        : [];
                }
                _saveRecent(e) {
