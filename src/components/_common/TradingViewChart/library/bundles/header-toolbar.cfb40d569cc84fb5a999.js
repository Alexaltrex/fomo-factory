    ...
    [3005],
    {
        ...
        53374: (e, t, s) => {
            ...
            const r = [
                {
                    name: "",
                    label: (0, a.t)("minutes", { context: "interval" }),
                },
                {
                    name: "H",
                    label: (0, a.t)("hours", { context: "interval" }),
                },
                { name: "D", label: (0, a.t)("days", { context: "interval" }) },
                {
                    name: "W",
                    label: (0, a.t)("weeks", { context: "interval" }),
                },
                {
                    name: "M",
                    label: (0, a.t)("months", { context: "interval" }),
                },
            ];
        },
        53335: (e, t, s) => {
                    ...
                    super(e, t),
                        ...
                        (this._fixLastGroup = (e, t, s) => {
                            if (
                                ...
                                const t =
                                    void 0 !== this.context.tools.Publish &&
                                    !this.props.readOnly;
            ...
            class Z {
                constructor(e) {
                    (this._customIntervalsService = G),
                        ...
                        O.linking.range.subscribe(
                            this._fireSupportedIntervalsMayChange
                        ),
                        O.linking.seconds.subscribe(
                            this._fireSupportedIntervalsMayChange
                        ),
                        O.linking.ticks.subscribe(
                            this._fireSupportedIntervalsMayChange
                        ),
                        O.linking.intraday.subscribe(
                            this._fireSupportedIntervalsMayChange
                        );
                }
                destroy() {
                    O.linking.supportedResolutions.unsubscribe(
                        ...
                        O.linking.range.unsubscribe(
                            this._fireSupportedIntervalsMayChange
                        ),
                        O.linking.seconds.unsubscribe(
                            this._fireSupportedIntervalsMayChange
                        ),
                        O.linking.ticks.unsubscribe(
                            this._fireSupportedIntervalsMayChange
                        ),
                ...
                getResolutionUtils() {
                    return {
                        ...
                        getTranslatedResolutionModel:
                            P.getTranslatedResolutionModel,
            ...
            class se {
                ...
                _loadFavs() {
                    const e = this._settings.getJSON(
                        "studyMarket.favorites",
                        []
                    );
            ...
            class fe extends a.PureComponent {
                constructor(e) {
                    ...
                    (this._favoriteIntervalsService =
                        ...
                        (this._features = {
                            ...
                            showLaunchInPopupButton: Boolean(
                ...
                addDropdown(e, t) {
                    const { leftCustomElements: s, rightCustomElements: a } =
                            this.state,
                ...
                updateDropdown(e, t) {
                    ...
                    void 0 !== a &&
                        ...
                        this.setState({
                            leftCustomElements:
                                this.state.leftCustomElements.slice(),
                            rightCustomElements:
                                this.state.rightCustomElements.slice(),
                        }));
                }
                removeDropdown(e) {
        ...
        39440: (e, t, s) => {
            ...
            function p(e) {
                return a.createElement("div", {
                    className: r(u.fadeLeft, e.className, {
                        [u.isVisible]: e.isVisible,
                    }),
                });
            }
            function v(e) {
                return a.createElement("div", {
                    className: r(u.fadeRight, e.className, {
                        [u.isVisible]: e.isVisible,
                    }),
                });
            }
                ...
                return (
                    ((h = class extends a.PureComponent {
                        ...
                        animateTo(e, t = c.dur) {
                            ...
                            s &&
                                ((0, d.isRtl)() &&
                                    (e = (0, d.getLTRScrollLeftOffset)(s, e)),
                                t <= 0
                                ...
                                a.createElement(
                                    ...
                                    a.createElement(
                                        "div",
                                        {
                                            className: r(
                                                u.wrap,
                                                w ? u.wrapWithArrowsOuting : ""
                                            ),
                                        },
                                        a.createElement(
                                            "div",
                                            {
                                                className: r(u.scrollWrap, f, {
                                                    [u.noScrollBar]: !l,
                                                }),
