(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
    [5093],
    {
        ...
        34451: (e) => {
            e.exports = {
                ...
                timeMarkSegmentAlignByEnds:
                    "timeMarkSegmentAlignByEnds-mKjO2NIu",
        ...
        62101: (e, t, s) => {
            ...
            class q {
                ...
                updatePosition() {
                    ...
                    const t =
                        this._chart.timeAxisHeight() + this._bottomMargin();
                ...
                _initHandlers() {
                    ...
                    this._buttons.turn.addEventListener("click", (e) => {
                        ...
                        this._buttons.minimize.addEventListener(
                            "click",
                            (e) => {
                                e.preventDefault(),
                                    this._chart
                    ...
                    return [
                        {
                            ...
                            available:
                                this._isMaximizeButtonAvailable.bind(this),
                ...
                _updateBackBtnPosition() {
                    if (
                        ...
                        const e =
                            this._chart.getPriceAxisMaxWidthByName(
                                this._priceAxisName
                            ) + 14;
                ...
                _updateBtnGroupVisibility() {
                    ...
                    let s =
                            2 * Math.min(e - t, t - this._leftPriceScaleWidth) -
                            50 -
                            50,
                        i = !1;
                ...
                _updateControlBarPosition() {
                    const e = this._visibilityPrioritizedGroups.reduce(
                            (e, t) =>
                                e + (t.enoughSpaceForGroup ? t.totalWidth : 0),
                            0
                        ),
                        t =
                            (this._paneWidth +
                ...
                _toggleFullscreenButtons() {
                    ...
                    this._buttons.maximize.classList.toggle("js-hidden", e),
                        this._buttons.minimize.classList.toggle(
                            "js-hidden",
                            !e
                        );
                }
        ...
        74335: (e, t, s) => {
            ...
            class M {
                constructor(e, t, s) {
                    (this._el = null),
                        ...
                        (this._updateLoadingState = (
                            ...
                            null !== this._loader &&
                                this._loader.toggleVisibility(e);
                        }),
                        (this._model = e),
                        (this._parentEl = t),
                        ...
                        this._loading.subscribe(
                            (function (e, t) {
                                ...
                                return (i) => {
                                    clearTimeout(s),
                                        i ? e() : (s = setTimeout(e, t));
                                };
                            })(this._updateLoadingState, 700)
                        ),
                        (this._isTitleHidden = this._model
                            .isTitleHidden()
                            .spawn()),
                        (this._isValuesHidden = this._model
                            .isValuesHidden()
                            .spawn()),
                    ...
                    (this._values = this._model.values().spawn()),
                        ...
                        (this._actionsSpawnArray = this._model
                            ...
                            .map((e) => ({
                                ...
                                title:
                                    void 0 === e.title ? null : e.title.spawn(),
                            })));
                    for (let e = 0; e < this._actionsSpawnArray.length; e++) {
                        ...
                        null !== t &&
                            t.subscribe(this._updateActionTitle.bind(this, e));
                    }
                    (this._withActions = s.withActions),
                        ...
                        this._withActions &&
                            ((this._showActionsHandler = (0,
                            m.wrapHandlerWithPreventEvent)(
                                this._showActions.bind(this)
                            )),
                            (this._hideActionsHandler = (0,
                            m.wrapHandlerWithPreventEvent)(
                                this._hideActions.bind(this)
                            )),
                            (this._selectedSourceHandler = (0,
                            m.wrapHandlerWithPreventEvent)(
                                    ...
                                    new p.MouseEventHandler(
                                        this._titleParentEl,
                                        {
                                            mouseDoubleClickEvent:
                                                this._model.onShowSettings.bind(
                                                    this._model
                                                ),
                                            doubleTapEvent:
                                                this._model.onShowSettings.bind(
                ...
                destroy() {
                    ...
                    if (
                        ...
                        (0, i.ensureNotNull)(this._el.parentNode).removeChild(
                            this._el
                        ),
                            (this._el = null);
                    }
                ...
                _render() {
                    this._renderTitle(),
                        ...
                        this._el.appendChild(
                            (0, i.ensureNotNull)(this._valuesParentEl)
                        ),
                ...
                _renderActions() {
                    ...
                    null === this._actionsParentEl &&
                        ...
                        (this._actionAdditionalWrapperEl =
                            document.createElement("div")),
                        this._actionAdditionalWrapperEl.classList.add(
                            S.buttons
                        ),
                ...
                _updateValueColorHandler(e, t = "") {
                    (0, i.ensure)(this._valuesElements[e].value).style.color =
                        t;
                }
                _updateValueVisibleHandler(e, t) {
                    const s = (0, i.ensure)(
                        this._valuesElements[e].value
                    ).closest("." + S.valueItem);
                ...
                _addValuesSpawnsSubscriptions() {
                    for (let e = 0; e < this._valuesSpawnArray.length; e++) {
                        ...
                        t.value.subscribe(
                            this._updateValuesHTMLElHandler.bind(this, e)
                        ),
                            t.color.subscribe(
                                this._updateValueColorHandler.bind(this, e)
                            ),
                            t.visible.subscribe(
                                this._updateValueVisibleHandler.bind(this, e)
                            ),
                            t.title.subscribe(
                                this._updateValuesTitleHTMLElHandler.bind(
                                    this,
                                    e
                                )
                            );
                ...
                _addStatusesWidget(e, t, s) {
                    (this._statusesWrapper = document.createElement("div")),
                        ...
                        this._updateStatusWidgetVisibility(
                            this._disabled.value()
                        ),
                ...
                _updateInvisibleHoverMode(e) {
                    null !== this._el &&
                        this._el.classList.toggle(S.invisibleHover, !e);
                }
                _updateHideValuesMode(e) {
                    null !== this._el &&
                        this._el.classList.toggle(S.hideValues, e);
                }
                _showActions() {
                ...
                _handlerRestrictTitleWidth(e) {
                    ...
                    let t = null,
                        s = null;
                    for (const i of e)
                        i.target === this._statusesWrapper &&
                            (t = i.contentRect.width),
                            i.target === this._actionsParentEl &&
                ...
                _updateStatusWidgetVisibility(e) {
                    null !== this._statusesWrapper &&
                        this._statusesWrapper.classList.toggle(
                            g.blockHidden,
                            e
                        );
                }
            ...
            class f extends M {
                constructor(e, t, s) {
                    super(e, t, s),
                        ...
                        this._flagged.subscribe(
                            this._updateFlaggedState.bind(this)
                        ),
                        this._updateStates(),
                        s.statusWidgetEl &&
                        ...
                        this._selected.subscribe(
                            this._updateTitleMaxWidth.bind(this)
                        );
                }
                destroy() {
                    super.destroy(),
                ...
                _renderValues() {
                    ...
                    for (const s of t) {
                        ...
                        o.classList.add(S.valueValue),
                            ...
                            o.appendChild(
                                document.createTextNode(s.value.value())
                            ),
                            t.appendChild(o),
            ...
            class E extends M {
                constructor(e, t, s) {
                    super(e, t, s),
                        ...
                        (this._has5Buttons = this._model
                            .isPineScriptDataSource()
                            .spawn()),
                        this._has5Buttons.subscribe(
                            this._update5ButtonsStyles.bind(this)
                        ),
                        ...
                        s.withActions &&
                            ((this._wheelClickHandler =
                                this._onWheelClicked.bind(this)),
                            null !== this._titleParentEl &&
                                this._titleParentEl.addEventListener(
                                    C,
                                    this._wheelClickHandler
                ...
                _renderValues() {
                    ...
                    for (const s of t) {
                        ...
                        void 0 !== l &&
                            (i.classList.add("apply-common-tooltip"),
                            (i.title = l)),
                            t.appendChild(i),
            ...
            class P {
                constructor(e, t, s) {
                    (this._el = null),
                        ...
                        this._themedColor.subscribe(
                            this._updateThemedColor.bind(this)
                        ),
                        ...
                        this._updateObjectTreeVisibility(
                            this._showObjectsTree.value()
                        ),
                        (this._toggleStateHandler = (0,
                        m.wrapHandlerWithPreventEvent)(
                            s.onCollapseDataSources
                        )),
                        (this._showObjectTreeHandler = (0,
                        m.wrapHandlerWithPreventEvent)(
                ...
                _render() {
                    (this._el = document.createElement("div")),
                        ...
                        (this._objectTreeEl.innerHTML =
                            u.trackingModeIsAvailable ? A : L),
                        ...
                        this._counterEl.appendChild(
                            document.createTextNode(
                                String(this._sourceCount.value())
                            )
                        ),
                ...
                _updateThemedColor(e) {
                    if (null !== this._el)
                        if (e.length > 0) {
                            ...
                            this._el.style.backgroundColor = (0,
                            r.rgbaToString)([
                                t,
                                s,
                                i,
            ...
            class j {
                constructor(e, t) {
                    (this._renderToggler = null),
                        ...
                        (this._isStudiesLegendHidden =
                            e.isStudiesLegendHidden.spawn()),
                        ...
                        (this._hideAllExceptFirstLine =
                            e.hideAllExceptFirstLine.spawn()),
                        ...
                        this._showBackground.subscribe(
                            this._setCustomBg.bind(this)
                        ),
                        (this._backgroundTransparency =
                            e.backgroundTransparency.spawn()),
                    ...
                    this._mouseEventHandler = new p.MouseEventHandler(
                        this._parentEl,
                        { contextMenuEvent: s, touchContextMenuEvent: s }
                    );
                }
                destroy() {
                    if (
                    ...
                    this._renderMainDataSourceEl(),
                        (this._mainDataSourceRenderer = new f(
                            ...
                            (0, i.ensureNotNull)(this._mainDataSourceEl),
                            {
                                ...
                                hideInvisibleHover: z(
                                    t.visibleWidgetsCount,
                                    (e) => Boolean(e)
                                ),
                    ...
                    for (let i = 0; i < e.length; i++) {
                        ...
                        this._dataSourceRenderers.push(o),
                            ...
                            l.onDestroy().subscribe(
                                ...
                                () => {
                                    const e =
                                        this._dataSourceRenderers.indexOf(o);
                                    -1 !== e &&
                ...
                _renderMainDataSourceEl() {
                    null === this._mainDataSourceEl &&
                        ((this._mainDataSourceEl =
                            document.createElement("div")),
                        this._mainDataSourceEl.classList.add(
                            S.legendMainSourceWrapper
                        ),
                ...
                _renderDataSourcesEl() {
                    null === this._dataSourcesEl &&
                        ...
                        (this._dataSourcesAdditionalWrapperEl =
                            document.createElement("div")),
                        this._dataSourcesAdditionalWrapperEl.classList.add(
                            S.sources
                        ),
            ...
            class se {
                constructor(e, t, s, i, l) {
                    (this._values = new (o())([])),
                        ...
                        (this._isTitleHidden = new (o())(
                            this._getTitleHiddenValue()
                        )),
                        (this._isValuesHidden = new (o())(
                            this._getValuesHiddenValue()
                        )),
                        (this._isRowHidden = new (o())(
                            this._getRowHiddenValue()
                        )),
                        (0, K.combine)(
                            () => ({}),
                            this._isTitleHidden,
                ...
                setSourceSelected() {
                    this._model.selectionMacro((e) => {
                        e.clearSelection(),
                            e.addSourceToSelection(this._source);
                    });
                }
                _moreActionHandler(e) {
                    e.preventDefault(),
                        null !== this._moreActionCM &&
                        this._moreActionCM.isShown()
                            ? (this._moreActionCM = null)
                            : (this.setSourceSelected(),
            ...
            class _e extends se {
                ...
                _updateTitles() {
                    ...
                    this._titles.title.setValue((0, F.clean)(t.title, !0)),
                        this._titles.description.setValue(
                            (0, F.clean)(t.description, !0)
                        ),
                        ce ||
                            this._titles.interval.setValue(
                                (0, F.clean)(t.interval, !0)
                            ),
                        this._titles.provider.setValue(
                            (0, F.clean)(t.provider, !0)
                        ),
                        this._titles.exchange.setValue(
                            (0, F.clean)(t.exchange, !0)
                        ),
                        this._titles.chartStyle.setValue(
                            (0, F.clean)(t.chartStyle, !0)
                        ),
                        this._titles.branding.setValue(
                            (0, F.clean)(
                                null !== (e = t.branding) && void 0 !== e
                                    ? e
                                    : "",
                                !0
                            )
                ...
                _getValuesHiddenValue() {
                    return (
                        !this._hasValues() ||
                        !this._valuesVisibleProperty.value()
                    );
                }
                _createActions() {
                    if (ue) {
                    ...
                    if (!this._options.readOnlyMode) {
                        if (
                            ...
                            const t = {
                                ...
                                action: (0, m.wrapHandlerWithPreventEvent)(
                                    this.onShowSettings.bind(
                                        this,
                                        ie.TabNames.visibility
                                    )
                                ),
                                visible: new (o())(
                                    this._getDisabledOnIntervalState()
                            ...
                            this._actions.push(t),
                                this._disabledOnInterval.subscribe((s) => {
                                    t.visible.setValue(s),
                                        e.visible.setValue(!s);
                                });
                        }
                        We &&
                            Le &&
            ...
            function bt(e, t) {
                return (
                    e.start.value === t.start.value &&
                    e.end.value === t.end.value
                );
            }
            function vt(e, t) {
                return bt(e[0], t[0]);
            ...
            class Mt {
                ...
                _updateEntriesBySubSessions(e) {
                    ...
                    const s = this._createSubSessionSpecs(e),
                        l =
                            (o =
                                (null === (t = this._todayInExchangeTime) ||
                                void 0 === t
                                    ? void 0
                ...
                _updateTodayWithOffsets(e) {
                    if (null === e)
                        return void (this._todayInExchangeTime = null);
                    const t = 1e3 * window.ChartApiInstance.serverTimeOffset();
                    this._todayInExchangeTime =
                        dt.get_cal_from_unix_timestamp_ms(
            ...
            function Bt(e) {
                ...
                return ft.createElement(
                    ...
                    ft.createElement(
                        "div",
                        { className: Vt.sessionDaySegments },
                        s
                    )
                );
            }
            function Dt(e) {
                ...
                const n =
                    !a.end.isFirstOrLastPoint && a.showEndForFirstEntry
                        ? o.entries[0].end
                        : a.end;
                if ((i[0].value !== n.value && i.push(n), 0 === i.length))
                    return null;
                ...
                const r = i.map((e) =>
                    ...
                    h = Ct(
                        d > 12 && Vt.timeMarkSegmentAlignByEnds,
                        Vt.timeMarkSegment
                    );
                return ft.createElement(
                    "div",
            ...
            class Pt {
                ...
                renderer(e, t) {
                    return (function (e) {
                        ...
                        className: t,
                        sessionDays:
                            this._fullSessionScheduleViewModel.sessionsDays,
            ...
            class Nt {
                constructor(e) {
                    (this.isBlinkingMode = new (o())(!1)),
                        ...
                        this._status.subscribe(
                            this._updateByStatus.bind(this),
                            { callWithLast: !0 }
                        ),
                        this._className.subscribe(
                            this._updateIconClassName.bind(this)
                        );
                }
                turnOffBlinkingMode() {}
                status() {
                ...
                _getTooltip(e) {
                    ...
                    return null !==
                        (s =
                            null === (t = this._infoMaps.tooltipMap) ||
                            void 0 === t
                                ? void 0
                                : t.get(e)) && void 0 !== s
                        ? s
                ...
                _getTitle(e) {
                    ...
                    return null !==
                        (s =
                            null === (t = this._infoMaps.titleMap) ||
                            void 0 === t
                                ? void 0
                                : t.get(e)) && void 0 !== s
                        ? s
                ...
                _getTitleColor(e) {
                    ...
                    return null !==
                        (s =
                            null === (t = this._infoMaps.titleColorMap) ||
                            void 0 === t
                                ? void 0
                                : t.get(e)) && void 0 !== s
                        ? s
                ...
                _getAction(e) {
                    ...
                    return null !==
                        (s =
                            null === (t = this._infoMaps.actionMap) ||
                            void 0 === t
                                ? void 0
                                : t.get(e)) && void 0 !== s
                        ? s
            ...
            const es = (0, be.getLogger)("Chart.LegendWidget"),
                ...
                ls = new Map([
                    ...
                    [
                        "CHIXAuDelayForGuest",
                        Ot.colorsPalette["color-delay-mode"],
                    ],
                    ...
                    [
                        "BATSToRealtime",
                        Ot.colorsPalette["color-notaccurate-mode"],
                    ],
                    [
                        "DelayWithoutMarketAgreement",
                        Ot.colorsPalette["color-delay-mode"],
                ...
                ps = (0, It.htmlEscape)(
                    (0, k.t)("Data is updated once a day.")
                ),
                ms = (0, It.htmlEscape)(
                    (0, k.t)(
            ...
            class Ms extends Nt {
                constructor(e, t, s) {
                    super({
                        ...
                        (this.turnOffBlinkingMode =
                            this._turnOffBlinking.bind(this)),
                        this.setModel(e);
                }
                destroy() {
                ...
                setModel(e) {
                    if ((this._dataUpdatedMode.destroy(), null === e))
                        return (
                            (this._model = e),
                            void (this._dataUpdatedMode = new (o())(
                                null
                            ).spawn())
                        );
                ...
                async _getHtmls() {
                    ...
                    for (const o of e)
                        if (
                            ...
                            "TickByTick" === o &&
                                (t[o].push(
                                    this._options.subscriptionFullInfo ? ms : gs
                                ),
                                this._options.subscriptionFullInfo &&
                                    t[o].push(bs)),
                ...
                async _getActions() {
                    if (
                        null === this._dataUpdatedMode.value() ||
                        null === this._model
                    )
                        return null;
                    const e = {};
                    ...
                    for (const i of t)
                        if (
                            ...
                            let t =
                                null !==
                                    (e =
                                        this._model.firstReplacedByBatsExchange()) &&
                                void 0 !== e
                                    ? e
                                    : "";
                            0,
            ...
            class Os extends Nt {
                ...
                _updateStatus(e) {
                    var t;
                    const s =
                        null !== (t = null == e ? void 0 : e.severity) &&
                        void 0 !== t
                            ? t
                            : null;
            ...
            class Zs {
                constructor(e, t, s, i) {
                    ...
                    u.trackingModeIsAvailable && l.push(zt.touchMode),
                        ...
                        this._tooltips.subscribe(
                            this._updateTooltip.bind(this)
                        ),
                ...
                _onClick(e) {
                    e.preventDefault();
                    const t = this._iconsRenderers.filter((e) =>
                        e.visible().value()
                    );
                ...
                _updateSpecialClassAndTooltip() {
                    ...
                    this.element.classList.toggle(
                        zt.oneWidgetsVisible,
                        1 === e
                    ),
                        this.element.classList.toggle(
                            zt.twoWidgetsVisible,
                            2 === e
                        ),
                        this.element.classList.toggle(
                            zt.threeWidgetsVisible,
                            3 === e
                        ),
                        this._updateTooltip();
                }
            ...
            const Ai = {
                    ...
                    pre_market: (e) =>
                        wi.format({ remainingTime: Li(e.remainingSeconds) }),
                    post_market: (e) =>
            ...
            class Bi extends Nt {
                ...
                _shouldBeHiddenByStatus(e) {
                    return (
                        !Pe.showMarketOpenStatusProperty.value() &&
                        "market" === e
                    );
                }
                _updateStatus(e) {
            ...
            class Di {
                constructor(e, t) {
                    ...
                    (this.visibleWidgetsCount = new (o())(0)),
                        ...
                        (this._size = u.trackingModeIsAvailable
                            ? "medium"
                            : "small"),
                ...
                _isPrimaryWidgetShown() {
                    ...
                    return (
                        null !==
                            (t =
                                null === (e = this._source.isSymbolInvalid()) ||
                                void 0 === e
                                    ? void 0
                                    : e.value()) &&
                        void 0 !== t &&
                ...
                _updateVisibleWidgetsCount() {
                    const e = this._statusWidgetInfos.filter((e) =>
                        e.visible.value()
                    );
                ...
                _recreateWidgets() {
                    ...
                    if (this._options.sourceStatusesEnabled) {
                        ...
                        if (null !== e)
                            if (null === this._symbolInvalidViewModel) {
                                ...
                                const t = this._symbolInvalidViewModel
                                    .visible()
                                    .spawn();
                                this._visibilitySpawns.push(t),
                                    this._tooltipSpawns.push(
                                        this._symbolInvalidViewModel
                                            .tooltip()
                                            .spawn()
                                    );
                                const s = {
                        ...
                        if (null === this._dataSourceErrorStatusViewModel) {
                            (this._dataSourceErrorStatusViewModel = new Ls(
                                ...
                                (this._dataSourceHasErrorVisible = (0,
                                K.combine)(
                                    () =>
                        ...
                        if (null === this._dataUpdatedModeViewModel) {
                            ...
                            const t = (0, K.combine)(
                                () =>
                                    ...
                                    (0, i.ensureNotNull)(
                                        this._dataUpdatedModeViewModel
                                    )
                                        .visible()
                                        .value(),
                    ...
                    if (this._options.dataProblemEnabled) {
                        ...
                        if (null === this._dataProblemViewModel) {
                            (this._dataProblemViewModel = new Os(
                                e,
                                this._size
                            )),
                                (this._isDataProblemCritical =
                ...
                _updateErrorWidgetIsShown() {
                    ...
                    const l =
                            null !==
                                (t =
                                    null ===
                                        (e = this._source.isSymbolInvalid()) ||
                                    void 0 === e
                                        ? void 0
                                        : e.value()) &&
                            void 0 !== t &&
                        ...
                        o =
                            null !==
                                (i =
                                    null ===
                                        (s = this._dataSourceHasErrorVisible) ||
                                    void 0 === s
                                        ? void 0
                                        : s.value()) &&
                            void 0 !== i &&
                ...
                constructor(e, t) {
                    (this._symbol = null),
                        ...
                        e.properties().hasChild("symbol") &&
                            (this._symbol = (0,
                            Y.createWVFromGetterAndSubscription)(
            ...
            class Gi {
                constructor(e, t, s, i, l, n, r, d) {
                    ...
                    m.subscribe(this, () => {
                        ...
                        (this._isPaneMain = new (o())(
                            this._getIsPaneMainValue()
                        )),
                        (this._updateCollapsedSourcesModeThrottle = (0,
                        Fi.default)(
                            this._updateCollapsedSourcesMode.bind(this),
                            100
                        )),
                        (this._renderer = new j(
                            {
                                ...
                                showToggleButton:
                                    this._options.showToggleButton,
                                isStudiesLegendHidden:
                                    this._studiesLegendHidden.readonly(),
                                isAllLegendHidden:
                                    this._allLegendHidden.readonly(),
                                ...
                                showLegendWidgetContextMenu:
                                    this.onShowLegendWidgetContextMenu.bind(
                                        this
                                    ),
                                hideAllExceptFirstLine:
                                    this._hideAllExceptFirstLine,
                            },
                            {
                                ...
                                onCollapseDataSources:
                                    this.onCollapseDataSources.bind(this),
                ...
                destroy() {
                    ...
                    for (const e of Array.from(
                        this._customLegendWidgetsMap.keys()
                    ))
                        this._destroyCustomWidgetFromLayerBlock(e);
                    this._customLegendWidgetsMap.clear(),
                        this._renderer.destroy(),
                        delete this._renderer,
                        this._showLegendCalculatedProperty().unsubscribeAll(
                            this
                        ),
                ...
                addCustomWidgetToLegend(e, t) {
                    const s =
                            this._customLegendWidgetsFactoriesMap.get(
                                t.block
                            ) || new Map(),
                        i = s.get(t.position) || [];
                    i.push(e),
                ...
                onShowLegendWidgetContextMenu(e, t) {
                    if (this._options.readOnlyMode || !Xi)
                                ...
                                a.push(
                                    new Be.Action({
                                        ...
                                        onExecute: () =>
                                            Ne(
                                                e,
                                                Pe.showMarketOpenStatusProperty,
                                                je
                                            ),
                                    })
                                ),
                    ...
                    if (0 === a)
                        ...
                        for (let s = e.length - 1; s >= 0; s--)
                            this._dataSourceViewModels[t]
                                ? (this._dataSourceViewModels[t].updateSource(
                                      e[s]
                                  ),
                                  this._dataSourcesStatusesWidgets[
                                      t
                ...
                _updateCustomWidgetModeBySize() {
                    ...
                    for (const t of Array.from(
                        this._customLegendWidgetsMap.values()
                    ))
                        ...
                        if (null !== i) {
                            ...
                            if (e > a + 1) {
                                ...
                                return (
                                    ...
                                    void this._collapsedDataSourcesCount.setValue(
                                        e - a
                                    )
                                );
                            }
                        ...
                        for (const t of Array.from(e.values()))
                            for (const e of t) {
                                ...
                                this._customWidgetsVisibilities.push(t),
                                    t.subscribe(
                                        this._updateLegendVisibilities.bind(
                                            this
                                        )
                                    );
                                ...
                                this._customWidgetsHeights.push(s),
                                    s.subscribe(
                                        this._updateCollapsedSourcesMode.bind(
                                            this
                                        )
                                    );
                            }
                ...
                _updateLegendVisibilities() {
                    ...
                    const e = this._dataSourceRowsHidden.every((e) =>
                            e.value()
                        ),
                    ...
                    const s =
                        ...
                        i = this._customWidgetsVisibilities.some((e) =>
                            e.value()
                        );
                    this._allLegendHidden.setValue(e && s && !i);
                }
                _updateVisibleDataSourceCount() {
                    const e = this._dataSourceRowsHidden.filter(
                        (e) => !e.value()
                    ).length;
                    ...
                    for (const l of Array.from(t.keys())) {
                        ...
                        for (let t = o.length; t < a.length; t++) {
                            ...
                            0 === e &&
                                ...
                                o.push(s),
                                this._renderer.addCustomWidget(s, {
                                    block: e,
                                    position: l,
                                }),
                                (i = !0);
            ...
            class p {
                constructor(e, t, s) {
                    (this._parentEl = document.createElement("div")),
                        ...
                        (this._forceContextMenuMode =
                            s.forceContextMenuMode.spawn()),
                    ...
                    for (const [e, t] of Object.entries(this._actions)) {
                        ...
                        null !== i &&
                            i.subscribe(this._updateActionTitle.bind(this, s));
                    }
                    this._render(),
                ...
                _updateWidgetMode() {
                    ...
                    const e =
                        ...
                        t =
                            !this._doNotSwitchToContextMenuMode.value() &&
                            (this._forceContextMenuMode.value() ||
                                this._width < 666.65),
                        s = (0, r.ensureNotNull)(this._listActionsWrapperEl),
                        i = (0, r.ensureNotNull)(
                            this._listActionsElements.more
                        );
                ...
                _renderActions() {
                    null === this._listActionsWrapperEl &&
                        ((this._listActionsWrapperEl =
                            document.createElement("div")),
                        this._listActionsWrapperEl.classList.add(
                            c.buttonsWrapper
                        ),
                    ...
                    (this._listActionsElements.up = (0, u.createActionElement)(
                        ...
                        (this._listActionsElements.down = (0,
                        u.createActionElement)(
                            this._actions.down,
                            c.button,
                            c.buttonIcon,
                            _.blockHidden,
                        ...
                        (this._listActionsElements.collapse = (0,
                        u.createActionElement)(
                        ...
                        (this._listActionsElements.restore = (0,
                        u.createActionElement)(
                        ...
                        (this._listActionsElements.close = (0,
                        u.createActionElement)(
                            this._actions.close,
                            c.button,
                            c.buttonIcon,
                        ...
                        (this._listActionsElements.maximize = (0,
                        u.createActionElement)(
                        ...
                        (this._listActionsElements.minimize = (0,
                        u.createActionElement)(
                        ...
                        (this._listActionsElements.more = (0,
                        u.createActionElement)(
                            this._actions.more,
                            c.button,
                            c.buttonIcon,
            ...
            class K {
                constructor(e, t, s, i, l) {
                    (this._actions = {}),
                        ...
                        this._createActions(),
                        (this._visibilityTypeProperty = (0,
                        a.actualBehavior)()),
                        ...
                        (this._isPaneMaximize = new (V())(
                            this._getIsPaneMaximizeValue()
                        )),
                        (this._isWidgetShow = new (V())(
                            this._getIsWidgetShow()
                        )),
                        ...
                        (this._renderer = new p(l, this._actions, {
                            ...
                            doNotSwitchToContextMenuMode:
                                this._isPaneMaximize.readonly(),
                            forceContextMenuMode:
                                this._connectedToBroker.readonly(),
                            themedColor: this._themedColor.readonly(),
                        }));
                }
                destroy() {
                            ...
                            (function (e, t, s) {
                                ...
                                if (e.maximize.visible.value()) {
                                    ...
                                    i.push(
                                        new m.Action({
                                            actionId:
                                                "Chart.PaneControls.MaximizePane",
                                            icon: S,
                                            label: t.value(),
                                    ...
                                    i.push(
                                        new m.Action({
                                            actionId:
                                                "Chart.PaneControls.MinimizePane",
                                            icon: S,
                                            label: t.value(),
                                ...
                                if (e.collapse.visible.value()) {
                                    ...
                                    i.push(
                                        new m.Action({
                                            actionId:
                                                "Chart.PaneControls.CollapsePane",
                                            icon: y,
                                            label: t.value(),
                                ...
                                if (e.restore.visible.value()) {
                                    ...
                                    i.push(
                                        new m.Action({
                                            actionId:
                                                "Chart.PaneControls.RestorePane",
                                            icon: M,
                                            label: t.value(),
                                ...
                                if (e.down.visible.value()) {
                                    ...
                                    i.push(
                                        new m.Action({
                                            actionId:
                                                "Chart.PaneControls.MovePaneDown",
                                            icon: w,
                                            label: t.value(),
        ...
        967: (e, t, s) => {
            ...
            const o = {
                ...
                a = {
                    [l.WeekDays.SUNDAY]: (0, i.t)("Su", {
                        context: "day_of_week",
                    }),
                    [l.WeekDays.MONDAY]: (0, i.t)("Mo", {
                        context: "day_of_week",
                    }),
                    [l.WeekDays.TUESDAY]: (0, i.t)("Tu", {
                        context: "day_of_week",
                    }),
                    [l.WeekDays.WEDNESDAY]: (0, i.t)("We", {
                        context: "day_of_week",
                    }),
                    [l.WeekDays.THURSDAY]: (0, i.t)("Th", {
                        context: "day_of_week",
                    }),
                    [l.WeekDays.FRIDAY]: (0, i.t)("Fr", {
                        context: "day_of_week",
                    }),
                    [l.WeekDays.SATURDAY]: (0, i.t)("Sa", {
                        context: "day_of_week",
                    }),
                };
        },
