            ...
            class y {
                ...
                _drawPoints(t, e, i, n, s, r) {
                    ...
                    for (let u = 0; u < i.length; ++u) {
                        ...
                        if (
                            !(
                                (0, o.isInteger)(d.data) &&
                                a.linePointBeingEdited === d.data
                            )
                        ) {
                            if (
                                (s(
                                ...
                                if (d.subtract(l).length() <= h + y) {
                                    const i = Math.max(
                                        1,
                                        Math.floor(a.selectedStrokeWidth * e)
                                    );
            ...
            class r extends s.PriceAxisView {
                constructor(t, e) {
                    super(),
                        ...
                        (this._convertPriceToCoordinate =
                            e.convertPriceToCoordinate),
            ...
            class h extends u.StudyInputsPaneView {
                constructor(t, e, i) {
                    super(t, e, i),
                        ...
                        (this._isSelected = i.isSelected
                            ? i.isSelected
                            : () => !0),
                        (this._isHovered = i.isHovered
                            ? i.isHovered
                            : () => !0);
                }
                setEditable(t) {
                ...
                _fillInformationAboutPointsAndCursors(t, e) {
                    if (
                        ...
                        (this._cursors = []),
                        this._inputs.find(
                            (t) => Array.isArray(t) || "price" === t.type
                        ))
                    ) {
                ...
                _createStudyAnchor(t, e, i) {
                    const s = (0, r.lastMouseOrTouchEventInfo)().isTouch,
                        ...
                        l = this._inputs.indexOf(
                            this._model.activeItemBeingMoved()
                        ),
                        ...
                        p = {
                            ...
                            backgroundColors: this._studyAnchorColors(
                                t.points,
                                e
                            ),
                ...
                _getStudyAnchorRenderer(t) {
                    for (; this._studyAnchorRenderers.length <= t; )
                        this._studyAnchorRenderers.push(
                ...
                _fillCompositeRendrer(t, e) {
                    this._inputs.forEach((t) => {
                        if (Array.isArray(t)) {
                            ...
                            if (null !== n && null !== s) {
                                const t = this._createLineRendererForinput(
                                        n,
                                        e
                                    ),
                            ...
                            if (null !== e) {
                                const i = this._createLineRendererForinput(
                                    e,
                                    t
                                );
                        ...
                        if (null !== i) {
                            ...
                            const n = this._editable
                                ? new r.HitTestResult(
                                      ...
                                      {
                                          cursorType:
                                              o.PaneCursorType.HorizontalResize,
                                          activeItem: e,
                                      }
                                  )
                                : null;
