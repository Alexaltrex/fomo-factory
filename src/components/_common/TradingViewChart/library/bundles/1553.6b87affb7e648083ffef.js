        ...
        11553: (t, e, i) => {
            ...
            !(function (r, s, o, a) {
                ...
                function H(t) {
                    var e = t.length;
                    if (1 === e)
                        return { x: l(t[0].clientX), y: l(t[0].clientY) };
                ...
                W.prototype = {
                    ...
                    init: function () {
                        this.evEl &&
                            ...
                            this.evTarget &&
                                b(this.target, this.evTarget, this.domHandler),
                            this.evWin &&
                                b(z(this.element), this.evWin, this.domHandler);
                    },
                    destroy: function () {
                        this.evEl &&
                            ...
                            this.evWin &&
                                _(z(this.element), this.evWin, this.domHandler);
                    },
                };
                ...
                function nt(t, e) {
                    ...
                    return (
                        12 & e && (i = O(i.concat(n), "identifier", !0)), [i, n]
                    );
                }
                E(it, W, {
                    handler: function (t) {
