        ...
        8312: (e, t, n) => {
                ...
                _icon(e) {
                    if (this.props.checkable) {
                        ...
                        if (this.props.checked) {
                            const t =
                                    !this.props.icon && !this.props.iconChecked,
                                n =
                    ...
                    return this.props.toolbox
                        ? s.createElement(
                              "span",
                              {
                                  className: i(
                                      e.toolbox,
                                      this.props.showToolboxOnHover &&
                                          e.showToolboxOnHover
                                  ),
            ...
            class I extends s.PureComponent {
                            ...
                            return null === (e = this.context) || void 0 === e
                                ...
                                : e.registerSubmenu(
                                      ...
                                      (e) =>
                                          ...
                                          (null !==
                                              this._menuElementRef.current &&
                                              this._menuElementRef.current.contains(
                                                  e
                                              ))
                                  );
                        }),
                ...
                componentDidMount() {
                    this.props.action
                        .onUpdate()
                        .subscribe(this, this._updateState),
                ...
                componentWillUnmount() {
                    this.props.action
                        .onUpdate()
                        .unsubscribe(this, this._updateState),
                ...
                constructor(e) {
                    super(e),
                        ...
                        (this._handleFocusOnOpen = () => {
                            var e, t;
                            (null === (e = this.props.menuElementReference) ||
                            void 0 === e
                                ? void 0
                                : e.current) &&
                                this.props.takeFocus &&
                                (null ===
                                    (t = this.props.menuElementReference) ||
                                    void 0 === t ||
            ...
            function a(e) {
                return class extends s.PureComponent {
                    render() {
                        ...
                        return "parent" === n
                            ? a
                            : s.createElement(o.Portal, null, a);
                    }
                };
            }
        },
