    ...
    [7078],
    {
        ...
        72811: (e, t, n) => {
            ...
            function B(e) {
                const {
                    ...
                    c = o.useCallback(() => {
                        (0, f.loadTheme)(n, {
                            ...
                            n.readOnly() || window.saver.saveChartSilently(),
                                (0, A.trackEvent)(
                                    "GUI",
                ...
                return o.createElement(
                    ...
                    o.createElement(v.PopupMenuItem, {
                        ...
                        label: t,
                        onClick: c,
                        toolbox: o.createElement(k.RemoveButton, {
                            hidden: !w.mobiletouch && !a,
                            onClick: r,
                        }),
                    })
                );
            ...
            const x = (0, i.t)("Template"),
                ...
                L =
                    ((0, S.appendEllipsis)((0, i.t)("Save as")),
                    (0, i.t)("Apply to all"));
                ...
                constructor(e) {
                    super(e),
                        ...
                        (this._handleApplyDefaults = () => {
                            const { model: e, chartWidgetCollection: t } =
                                this.props;
                        ...
                        (this._handleRemoveTheme = (e) => {
                            this.setState({
                                themes: this.state.themes.filter(
                                    (t) => t !== e
                                ),
                            });
                        }),
                    ...
                    return o.createElement(
                        ...
                        l.length > 0 &&
                            o.createElement(
                                o.Fragment,
                                null,
                                o.createElement(y.PopupMenuSeparator, {
                                    key: "separator",
                                }),
                                l.map((e) =>
                                    o.createElement(B, {
            ...
            class H extends o.PureComponent {
                constructor(e) {
                    ...
                    super(e),
                        ...
                        (this._selectPage = (e, t) => {
                            ...
                            e !== n &&
                                ...
                                null !== e &&
                                    (t ||
                                        h().setValue(
                                            "properties_dialog.last_page_id",
                                            e.id
                                        ),
                        ...
                        (this._onChangeActivePageDefinitions = () => {
                            z.logger.logNormal(
                                "Definition collection was updated"
                            ),
                        ...
                        (this._onTabVisibilityChanged = () => {
                            const e = this.props.pages.filter((e) =>
                                e.visible.value()
                            );
                        ...
                        (this._handleApplyToAll = () => {
                            const { chartWidgetCollection: e, model: t } =
                                    this.props,
                                { isApplyToAllVisible: n } = this.state;
