                    ...
                    m = (function (t) {
                        ...
                        return (
                            0 !== t &&
                                ...
                                4 & t &&
                                    (e = n(e, l()["no-corner-bottom-right"])),
                                8 & t &&
                                    (e = n(e, l()["no-corner-bottom-left"]))),
                            e
                        );
        ...
        56588: (t, e, o) => {
            ...
            class _ extends n.FloatingToolbar {
                ...
                _correctPosition(t) {
                    ...
                    e.left > t.left &&
                        i > 0 &&
                        (t.left = Math.min(t.left + i, e.left)),
                        e.top > t.top &&
                            n > 0 &&
                            (t.top = Math.min(t.top + n, e.top));
                }
                _onFavoriteAdded(t) {
                ...
                _onSelectedLinetoolChanged(t) {
                    Object.keys(this._linetoolsWidgets).forEach((e) => {
                        this._linetoolsWidgets[e].classList.toggle(
                            "i-active",
                            t === e
                        );
                    });
                ...
                _attachHandlers() {
                    s.LinetoolsFavoritesStore.favoriteAdded.subscribe(
                        ...
                        s.LinetoolsFavoritesStore.favoritesSynced.subscribe(
                            null,
                            () => {
                                this._loadVisibilityState(),
                                    this._renderAllLinetools();
            ...
            class w {
                constructor(t) {
                            ...
                            if (l) {
                                ...
                                isFinite(t) &&
                                    (this._helper.nextLeft =
                                        o.clientX - i.clientX + t);
                            }
                            if (null !== this._helper.containment) {
                                const [t, e, o, i] = this._helper.containment;
                                a &&
                                    this._helper.nextTop &&
                                    ((this._helper.nextTop = Math.min(
                                        this._helper.nextTop,
                                        i
                                    )),
                                    (this._helper.nextTop = Math.max(
                                        this._helper.nextTop,
                                        e
                                    ))),
                                    l &&
                    ...
                    const n = (this._handle =
                        null !==
                            (e = t.handle ? i.querySelector(t.handle) : null) &&
                        void 0 !== e
                            ? e
                            : i);
                ...
                destroy() {
                    ...
                    this._handle.classList.remove("ui-draggable-handle"),
                        ...
                        null !== this._helper &&
                            (this._helper.raf &&
                                cancelAnimationFrame(this._helper.raf),
                            (this._helper = null));
                }
            }
            class y {
                    ...
                    (this._initial = null),
                        (this._handlePointerDown = (t) => {
                            ...
                            if (
                                !(
                                    ...
                                    this._handle.contains(t.target)
                                )
                            )
                                return;
                            if (
                        ...
                        (this._handlePointerMove = (t) => {
                            null !== this._initial &&
                                ...
                                (t.preventDefault(),
                                this._dispatchEvent(
                                    this._createEvent("pointer-drag-move", t)
                                ));
                        }),
            ...
            class T {
                    ...
                    (this._widget = document.createElement("div")),
                        ...
                        (this._preventClickUntilAnimation = (t) => {
                            null !== this._showTimeStamp &&
                                performance.now() - this._showTimeStamp <
                                    this.hideDuration() &&
                                t.stopPropagation();
                        }),
                        ...
                        (this._reactWidgetsContainer = this._widget
                            ...
                            .item(0)),
                        this._setZIndex(
                            T._startZIndex + T._toolbars.length - 1
                        ),
                        this._options.addClass &&
                            (this._widget.className +=
                                " " + this._options.addClass),
                        this._options["data-name"] &&
                            (this._widget.dataset.name =
                                this._options["data-name"]),
                        this._options.layout &&
                            "auto" !== this._options.layout &&
                            ((this._isVertical =
                                "vertical" === this._options.layout),
                    ...
                    if (n.mobiletouch) {
                        new p().load().then((e) => {
                            ...
                            o.get("press").set({ time: 500 }),
                                o.on("press", (e) => {
                                    this._preventWidgetTouchEndEvent(),
                                        t(e.srcEvent);
                                });
                        });
                ...
                _onWindowResize() {
                    if ("auto" === (this._options.layout || "auto")) {
                        ...
                        (this._isVertical =
                            this._determineCurrentLayoutVertical(e)),
                            this._updateLayoutType(),
                            t !== this._isVertical &&
                ...
                _initSortable() {
                    ...
                    lazyJqueryUI(this._content).sortable({
                        ...
                        distance: 5,
                        containment:
                            !!this._options.dragOnlyInsideToolbar && "parent",
                        scroll: !1,
        ...
        36052: (t, e, o) => {
                ...
                return i.createElement(T.ToolWidgetIconButton, {
                    ...
                    onClick: async function () {
                        ...
                        const t = o.model().selection().lineDataSources(),
                            e = t.length;
                        1 === e
                            ? await o.showChartPropertiesForSource(
                                  t[0],
                                  void 0,
                                  { onWidget: o.onWidget() }
                              )
                            : e > 1 &&
                              (await o.showChartPropertiesForSources({
                                  sources: t,
                              }));
                    },
                    "data-name": "settings",
                        ...
                        j.ToolWidgetMenu,
                        {
                            ...
                            onOpen: r
                                ...
                                : function () {
                                          ...
                                          e = (function () {
                                              ...
                                              i.length > 0 &&
                                                  t.push(
                                                      new H.Action({
                                                          actionId:
                                                              "Chart.LineTool.Clone",
                                                          name: "clone",
                                                          icon: o(16788),
                                                          shortcutHint:
                                                              z.humanReadableModifiers(
                                                                  O.Modifiers
                                                                      .Mod
                                                              ) +
                                                              e +
                                      ...
                                      e.length &&
                                          t.push(new H.Separator(), ...e);
                                      t.push(
                                          new H.Separator(),
                                          new H.Action({
                                              actionId:
                                                  "Chart.SelectedObject.Hide",
                                              label: (0, s.t)("Hide"),
                                              icon: X,
                                              onExecute: () => {
                            ...
                            onClick: r
                                ? function (t) {
                                      u.contextMenuActionsForSources(c).then(
                                          (e) => {
                                              window.matchMedia(
                                                  f.DialogBreakpoints
                                                      .TabletSmall
                                              ).matches
                                                  ? Y.ContextMenuManager.showMenu(
                                                        Z(e),
                                                        t,
                                                        {
                                                            mode: "drawer",
                    ...
                    c = (0, i.useMemo)(
                        () => [
                            new H.Action({
                                ...
                                onExecute: () =>
                                    o.setProperty(e, Q.LineStyle.Solid, r),
                            }),
                            new H.Action({
                                actionId:
                                ...
                                onExecute: () =>
                                    o.setProperty(e, Q.LineStyle.Dashed, r),
                            }),
                            new H.Action({
                                actionId:
                                ...
                                onExecute: () =>
                                    o.setProperty(e, Q.LineStyle.Dotted, r),
                            }),
                        ],
                        [o, e, l]
                    );
            ...
            class ct extends b.FloatingToolbar {
                constructor(t) {
                    super(ct._prepareOptions(t)),
                        ...
                        (this._onWindowClickedListener =
                            this._onWindowClicked.bind(this));
                }
                show() {
                    super.show(),
                ...
                findGroupedWidget(t) {
                    ...
                    for (let o = 0; o < e; ++o) {
                        if (this._statedWidgets[o].statedWidget.id === t)
                            return o;
                    }
                    return -1;
                }
                removeGroupedWidget(t) {
                    ...
                    for (let o = 0; o < e; ++o) {
                        ...
                        if (e.statedWidget.id === t)
                            return (
                                this._isPopupCreatedForWidget(t) &&
                                    this._closePopup(),
                                void 0 !== e.clickListener &&
                                    e.toolbarWidget.removeEventListener(
                                        "click",
                                        e.clickListener
                                    ),
                ...
                _onWidgetClicked(t, e) {
                    ...
                    this._closePopup(),
                        !o && t.isEnabled && this._createPopup(t);
                }
                _createPopup(t) {
                    const e = {
                    ...
                    t.statedWidget.states.forEach((i, n) => {
                        ...
                        this._getWidget().appendChild(
                            this._currentPopup.element
                        ),
                        Promise.resolve().then(() => {
                            this._currentPopup &&
                                this._currentPopup.element.classList.add(
                                    "i-opened"
                                );
                        }),
                        this._updatePopupPosition();
                ...
                _isPopupCreatedForWidget(t) {
                    return Boolean(
                        this._currentPopup &&
                            this._currentPopup.stateWidgetId === t
                    );
                }
                ...
                _onWindowClicked(t) {
                    if (
                        ...
                        for (let e = 0; e < this._statedWidgets.length; ++e)
                            if (
                                ct._isEventInElement(
                                    t,
                                    this._statedWidgets[e].toolbarWidget
                                )
                            )
                                return;
                        this._closePopup();
            ...
            class ft {
                constructor(t) {
                    (this._isDrawingFinished = new (c())(!0)),
                        ...
                        (this._isToolMovingNowSpawn =
                            p.isToolMovingNow.spawn()),
                        (this._isToolEditingNowSpawn =
                            p.isToolEditingNow.spawn()),
                        ...
                        this._isToolMovingNowSpawn.subscribe(
                            this._handleSourceEdit
                        ),
                        this._isToolEditingNowSpawn.subscribe(
                            this._handleSourceEdit
                        ),
                        this._toolSpawn.subscribe(
                    ...
                    this._updateVisibilityTimeout &&
                        ...
                        (this._updateVisibilityTimeout = setTimeout(() => {
                            (0, h.unsetNewToolProperties)(),
                                this._floatingToolbar.hide(!0),
                                this._isToolbarRendered() &&
                                    this._unmountToolbar(),
                                this._clearProperties(),
                                this._clearCommonButtons();
                        }, 0)),
                        null ===
                            (t = this._lineToolsDoNotAffectChartInvalidation) ||
                            void 0 === t ||
                            t.destroy(),
                ...
                _propertyApplierImpl() {
                    return (
                        this._propertyApplier ||
                            ...
                            (this._propertyApplier =
                                new pt.PropertyApplierWithoutSavingChart(
                ...
                _prepareProperties(t) {
                    ...
                    if (
                        !(
                            e.filter((e) => e.properties()[t].visible())
                                .length < 1
                        )
                    )
                        return e
                            .map((e) => e.properties()[t])
                            .filter(d.notNull);
                }
                ...
                _shouldShowBackgroundProperty(t, e) {
                    return (
                        !e || !e.fillBackground || !!e.fillBackground.value()
                    );
                }
                _isDrawingToolExcludingCustomUrlEventTool(t) {
                    return (
                        Boolean(
                            null == t
                                ? void 0
                                : t.toLowerCase().includes("linetool")
                        ) &&
                        "LineToolTweet" !== t &&
                        "LineToolIdea" !== t &&
                        "LineToolImage" !== t
            ...
            var c = o(58912),
                ...
                p =
                    (new n(
                        ...
                        i("apply drawing template")
                    ),
                    new n(
                        "change line tool(s) color",
                        i("change line tool(s) color")
                    )),
                u = new n(
            ...
            class B extends s {
                ...
                showPropertiesOf(t, e, o) {
                    this._toolExceptionCases ||
                        (this._toolExceptionCases =
                            this._createToolExceptionCases());
                    var i =
                        this._toolExceptionCases[t] ||
                        this._getPossibleProperty(e);
                    if (
                        (this._clearProperties(),
                        (this._propertiesVisible = !1),
                        i.length)
                ...
                _createToolExceptionCases() {
                    return {
                        LineToolBrush:
                            B.prototype._brushPropertiesExceptionCase(),
                        LineToolBezierQuadro:
                            B.prototype._bezierPropertiesExceptionCases(),
                        LineToolBezierCubic:
                            B.prototype._bezierPropertiesExceptionCases(),
                        LineToolText:
                            B.prototype._textPropertiesExceptionCases(),
                        ...
                        LineToolDateAndPriceRange:
                            B.prototype._rangeExceptionCases(),
                        LineToolNote:
                            B.prototype._notePropertiesExceptionCases(),
                        LineToolNoteAbsolute:
                            B.prototype._notePropertiesExceptionCases(),
                        LineToolRiskRewardLong:
                            B.prototype._riskPropertiesExceptionCases(),
                        LineToolRiskRewardShort:
                            B.prototype._riskPropertiesExceptionCases(),
                        LineToolPath: B.prototype._pathExceptionCases(),
                        LineToolRegressionTrend:
                            B.prototype._regressionToolExceptionCases(),
                        LineToolBarsPattern: [
                            {
                                name: "color",
                                title: m,
                ...
                constructor(t) {
                    super(t),
                        ...
                        (this._handleAddColor = () =>
                            this.props.onAdd(this.state.color));
                ...
                constructor(t) {
                    super(t),
                        ...
                        (this._onSliderClick = (t) => {
                            this._handlePosition(t.nativeEvent),
                                this._dragSubscribe();
                        }),
                        (this._mouseUp = (t) => {
