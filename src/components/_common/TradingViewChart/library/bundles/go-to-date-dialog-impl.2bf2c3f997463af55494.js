        ...
        54801: (e, t, s) => {
            ...
            function c(e, t = !1) {
                const s = l(e),
                    n = t
                        ? (function (e) {
                              if (e > 6)
                                  throw new Error("Invalid day is provided");
                              return 0 === e ? 6 : e - 1;
                          })(s.getDay())
                        : s.getDay();
            ...
            function P(e) {
                ...
                return n.createElement(
                    "div",
                    { className: y()(O.row, _e && O.mobileRow) },
                    t
                );
            }
            var T = s(32563),
                ...
                render() {
                    ...
                    return n.createElement(
                        "span",
                        {
                            ...
                            "data-day": this._dateFormatter.formatLocal(
                                this.props.day
                            ),
                        },
            ...
            class H extends n.PureComponent {
                ...
                _renderWeek(e) {
                    ...
                    return n.createElement(
                        "div",
                        { className: V.week, key: i },
                        t
                    );
                }
                _isDayDisabled(e) {
                    if (!p(e, this.props.minDate, this.props.maxDate))
                        return !0;
                    ...
                    super(e),
                        ...
                        (this._onClickDay = (e) => {
                            this.setState({ viewDate: new Date(e) }),
                                this.props.onSelect &&
                                    this.props.onSelect(new Date(e));
                        }),
                ...
                render() {
                    return n.createElement(
                        "div",
                        {
                            className: N(
                                V.calendar,
                                this.props.popupStyle && V.popupStyle,
                        ...
                        n.createElement(
                            ...
                            n.createElement(z.Icon, {
                                ...
                                className: N(V.switchBtn, V.prev),
                            }),
                            n.createElement(
                                "div",
                                { className: V.title },
                            ...
                            n.createElement(z.Icon, {
                                ...
                                className: N(V.switchBtn, V.next),
                            })
                        ),
                        n.createElement(H, {
                        ...
                        (this._onShowPicker = (e) => {
                            if (e && this._inputContainer) {
                                const t = e.getBoundingClientRect(),
                                    s =
                                        this._inputContainer.getBoundingClientRect();
                                ...
                                const n = window.innerHeight - s.bottom,
                                    r = s.top;
                                if (n >= t.height)
                                    return void (e.style.top = s.bottom + "px");
                                (e.style.top = "auto"),
                                    (e.style.bottom =
                                        r < t.height
                                            ? "0"
                    ...
                    super(e),
                        ...
                        (this._onBlur = () => {
                            this._nativeInputRef.current &&
                                (this._nativeInputRef.current.defaultValue =
                                    this.state.value),
                ...
                render() {
                    ...
                    return n.createElement(
                        ...
                        n.createElement(r, {
                            ...
                            intent:
                                !o && this.state.isFocused ? "primary" : void 0,
                        }),
                        i &&
            ...
            class te extends n.PureComponent {
                constructor(e) {
                    super(e),
                        ...
                        (this._onType = (e) => {
                            const t = this._isValid(e)
                                ? new Date(e.concat("T00:00"))
                                : null;
                            t
                ...
                render() {
                    return T.mobiletouch
                        ? n.createElement(q, {
                              value: this._dateFormatter.formatLocal(
                                  this.state.date
                              ),
                              type: "date",
                              ...
                              min:
                                  this.props.minDate &&
                                  this._dateFormatter.formatLocal(
                                      this.props.minDate
                                  ),
                              max:
                                  this.props.maxDate &&
                ...
                _getFontSizeClassName(e) {
                    return e
                        ? "large" === e
                            ? J.InputClasses.FontSizeLarge
                            : J.InputClasses.FontSizeMedium
                        : void 0;
                }
            }
            ...
            function fe(e, t) {
                const s = new Date(t);
                return (
                    s.setHours(e.getHours()), s.setMinutes(e.getMinutes()), s
                );
            }
            function ve(e) {
                const { dateOnly: t, onCalendarMonthSwitch: s } = e,
                    { date: r, setDate: o } = (0, i.ensureNotNull)(
                        (0, n.useContext)(b)
                    ),
                    a = (0, n.useRef)(null),
                    l = (0, n.useRef)(null);
            ...
            function ge(e) {
                const {
                    ...
                    } = e,
                    {
                        ...
                        setDateFrom: l,
                        setDateTo: c,
                    } = (0, i.ensureNotNull)((0, n.useContext)(C)),
                    [h, u] = (0, n.useState)("from"),
                    d = (0, n.useRef)(null),
                    p = (0, n.useRef)(null),
                    m = (0, n.useRef)(null),
                    f = (0, n.useMemo)(
                        () => ("from" === h ? new Date(o) : new Date(a)),
                        [h, a, o]
                    );
                return (
                    (0, n.useEffect)(() => {
            ...
            function Se(e) {
                const {
                    ...
                    a = (0, n.useRef)(null),
                    [l, c] = (0, n.useState)(
                        F().getValue("GoToDialog.activeTab", "Date")
                    ),
                    [h, u] = (0, n.useState)(0),
                    { date: d, isValid: p } = (0, i.ensureNotNull)(
                        (0, n.useContext)(b)
                    ),
                    {
                        dateFrom: m,
                ...
                return (
                    (0, n.useEffect)(
                        () => (
                            k.subscribe(
                                x.CLOSE_POPUPS_AND_DIALOGS_COMMAND,
                                _,
                                null
                            ),
                            () => {
                ...
                const t = e.model(),
                    ...
                    i = n.createElement(ye, {
                        ...
                        onGoToDate: (e) => {
                            !(function (e, t) {
                                Fe.setItem(
                                    "goToDateTabLastPickedDate",
                                    String(t.valueOf())
                                );
                                if (
                                    void 0 ===
                                    e.model().timeScale().tickMarks().minIndex
                                )
                                    return;
                                const s = v(t).valueOf();
                                e.model()
            ...
            function Pe(e) {
                const t = (function (e) {
                    ...
                    const n = e.model().mainSeries(),
                        r = n.nearestIndex(
                            s.firstBar(),
                            Me.PlotRowSearchMode.NearestRight
                        ),
                        o = n.nearestIndex(
                            s.lastBar(),
                            Me.PlotRowSearchMode.NearestLeft
                        );
                    if (void 0 === r || void 0 === o) return;
                    return {
                        from: (0, i.ensureNotNull)(t.indexToUserTime(r)),
                        to: (0, i.ensureNotNull)(t.indexToUserTime(o)),
                    };
                })(e);
                return t
                    ? { from: f(t.from), to: f(t.to) }
                    : { from: f(new Date()), to: f(new Date()) };
            }
        },
        39640: (e, t, s) => {
            "use strict";
                    ...
                    n.createElement(
                        ...
                        n.createElement(
                            ...
                            s &&
                                n.createElement(
                                    "div",
                                    { className: o()(D.ellipsis, D.subtitle) },
                                    s
                                )
                        ),
                        l,
        ...
        39440: (e, t, s) => {
            ...
            function m(e) {
                return n.createElement("div", {
                    className: r(d.fadeLeft, e.className, {
                        [d.isVisible]: e.isVisible,
                    }),
                });
            }
            function f(e) {
                return n.createElement("div", {
                    className: r(d.fadeRight, e.className, {
                        [d.isVisible]: e.isVisible,
                    }),
                });
            }
            ...
            function w(e) {
                return n.createElement(
                    ...
                    n.createElement(
                        ...
                        n.createElement(a.Icon, { icon: u, className: d.icon })
                    )
                );
            }
                ...
                return (
                    ((u = class extends n.PureComponent {
                        ...
                        animateTo(e, t = c.dur) {
                            ...
                            s &&
                                ((0, h.isRtl)() &&
                                    (e = (0, h.getLTRScrollLeftOffset)(s, e)),
                                t <= 0
                                ...
                                n.createElement(
                                    ...
                                    n.createElement(
                                        "div",
                                        {
                                            className: r(
                                                d.wrap,
                                                _ ? d.wrapWithArrowsOuting : ""
                                            ),
                                        },
                                        n.createElement(
                                            "div",
                                            {
                                                className: r(d.scrollWrap, g, {
                                                    [d.noScrollBar]: !l,
                                                }),
