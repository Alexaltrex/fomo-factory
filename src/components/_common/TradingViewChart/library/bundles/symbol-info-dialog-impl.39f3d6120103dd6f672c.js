    ...
    [9374],
    {
        ...
        52217: (e, t, n) => {
            ...
            class v extends r.PureComponent {
                constructor() {
                    super(...arguments),
                        (this._close = () => this.props.onClose());
                }
                componentDidMount() {
                    h.subscribe(
        ...
        65398: (e, t, n) => {
            ...
            function U(e) {
                N ||
                    ...
                    c.render(l.createElement(u, e), N);
            }
            function Y(e) {
                ...
                if (
                    ...
                    var n = t && t.symbolInfo,
                        i = [
                            {
                                title: o("Symbol Name"),
                                propName: w.enabled("charting_library_base")
                                    ? "name"
                                    : "pro_name",
                            },
                            {
                                title: o("Symbol Description"),
                            ...
                            {
                                title: o("Listed Exchange"),
                                propName: "listed_exchange",
                            },
                            {
                                title: o("Source"),
                                propName: "source",
                                visibility: (e) => g(e) && e.source,
                            },
                            {
                                title: o("Currency"),
                            ...
                            },
                            {
                                ...
                                propName: "unit_id",
                                getter: (e) =>
                                    t.unitDescription(y(e, t.showUnit)),
                                visibility: (e) =>
                                    Boolean(y(e, t.showUnit)) && !v(e),
                                formatter: (e) => e || "",
                                defValue: "",
                            },
                            {
        ...
        967: (e, t, n) => {
            ...
            const i = {
                ...
                s = {
                    [r.WeekDays.SUNDAY]: (0, o.t)("Su", {
                        context: "day_of_week",
                    }),
                    [r.WeekDays.MONDAY]: (0, o.t)("Mo", {
                        context: "day_of_week",
                    }),
                    [r.WeekDays.TUESDAY]: (0, o.t)("Tu", {
                        context: "day_of_week",
                    }),
                    [r.WeekDays.WEDNESDAY]: (0, o.t)("We", {
                        context: "day_of_week",
                    }),
                    [r.WeekDays.THURSDAY]: (0, o.t)("Th", {
                        context: "day_of_week",
                    }),
                    [r.WeekDays.FRIDAY]: (0, o.t)("Fr", {
                        context: "day_of_week",
                    }),
                    [r.WeekDays.SATURDAY]: (0, o.t)("Sa", {
                        context: "day_of_week",
                    }),
                };
        },
