        ...
        94720: (e, t, n) => {
                    ...
                    f = (function (e) {
                        ...
                        return (
                            0 !== e &&
                                ...
                                4 & e &&
                                    (t = o(t, l()["no-corner-bottom-right"])),
                                8 & e &&
                                    (t = o(t, l()["no-corner-bottom-left"]))),
                            t
                        );
            ...
            function m(e) {
                const { reference: t, ...n } = e,
                    ...
                    } = (0, s.useContext)(d.ControlGroupContext),
                    a = c({
                        ...n,
                        isGrouped: o,
                        cellState: r,
                ...
                render() {
                    ...
                    return (
                        ...
                        s.createElement(
                            "label",
                            { className: r },
                            s.createElement(i.CheckboxInput, {
                                ...n,
                                className: e,
                            }),
                            c
        ...
        67029: (e, t, n) => {
            ...
            function p(e, t, n, s) {
                const {
                    ...
                    C = h(
                        null != r ? r : (0, c.getGroupCellRemoveRoundBorders)(n)
                    );
                return o(
                    d().container,
                    d()["intent-" + a],
            ...
            function m(e, t) {
                ...
                const r = h(
                    null != s ? s : (0, c.getGroupCellRemoveRoundBorders)(t)
                );
                return o(d().highlight, d().shown, r);
            }
            const g = {
                    FontSizeMedium: (0, r.ensureDefined)(
                        d()["font-size-medium"]
                    ),
                ...
                const {
                    ...
                    O = (function (e, t = null, n) {
                        const o = (0, s.useRef)(null),
                            r = (0, s.useRef)(null),
                            i = (0, s.useCallback)(() => {
                                if (null === o.current || null === r.current)
                                    return;
                                const [e, t, n] = r.current;
                                null !== t &&
                                    o.current.addEventListener(e, t, n);
                            }, []),
                            a = (0, s.useCallback)(() => {
                                if (null === o.current || null === r.current)
                                    return;
                                const [e, t, n] = r.current;
                                null !== t &&
                                    o.current.removeEventListener(e, t, n);
                            }, []),
                            l = (0, s.useCallback)((e) => {
                                a(), (o.current = e), i();
                            }, []);
        ...
        48027: (e, t, n) => {
            ...
            function r(e) {
                const {
                    ...
                    u = (0, s.createSafeMulticastEventHandler)(
                        a ? void 0 : c.onFocus,
                        t
                    ),
                    d = (0, s.createSafeMulticastEventHandler)(
                        a ? void 0 : c.onBlur,
                        n
                    );
                return {
                ...
                constructor(e) {
                    if (
                        ...
                        (this._handleOutsideClick = () => {
                            ...
                            e
                                ? n && s !== t && n(s)
                                : this.setState(this._valueToQuery(t)),
                                this._close();
                        }),
                        (this._handleFocus = (e) => {
                        ...
                        (this._scrollIfNotVisible = (e, t) => {
                            ...
                            o <= n
                                ? e.scrollIntoView(!0)
                                : r >= s && e.scrollIntoView(!1);
                        }),
                        !((e) =>
                            Array.isArray(e.source) ||
                            !e.allowUserDefinedValues)(e))
                    )
                        throw new Error(
            ...
            class S extends i.PureComponent {
                ...
                render() {
                    ...
                    return i.createElement(b.AdaptiveConfirmDialog, {
                        ...
                        submitButtonText: i.createElement(y, {
            ...
            class z {
                ...
                _prepareData(e, t, n) {
                    ...
                    return {
                        ...
                        meta_info: (0, j.createStudyTemplateMetaInfo)(
                            this._controller,
                            s.interval
                        ),
                    };
                ...
                _showTemplateSaveRenameDialog(e, t, n) {
                    const s = (0, j.createStudyTemplateMetaInfo)(
                        this._controller
                    );
                    (this._dialog = new T({
                        ...
                        saveIntervalHintText: F.format({
                            interval: (0, R.translatedIntervalString)(n),
                        }),
            ...
            function r(e) {
                ...
                return (
                    (0, s.useLayoutEffect)(() => {
                        ...
                        return (0, o.addOutsideEventListener)(
                            d.current,
                            s,
                            a,
                            c,
        ...
        1109: (e, t, n) => {
            ...
            function i(e) {
                return s.createElement("div", {
                    className: o(r.separator, e.className),
                });
            }
        },
        88216: (e, t, n) => {
            ...
            function a(e = document) {
                ...
                if (null !== t) return (0, s.ensureDefined)(i.get(t));
                {
                    ...
                    return (
                        i.set(n, t), t.setContainer(n), e.body.appendChild(n), t
                    );
                }
            }
        },
