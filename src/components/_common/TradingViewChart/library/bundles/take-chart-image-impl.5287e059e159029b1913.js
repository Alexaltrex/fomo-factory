    ...
    [4389],
    {
        4897: (e, t, a) => {
            ...
            function p(e, t = {}) {
                return new Promise((a, n) => {
                    !(async function (e, t, a, n = {}) {
                        ...
                        n.asyncSave &&
                            r.append("asyncSave", String(n.asyncSave));
                        ...
                        "exchange" === p &&
                            (p =
                                (null ===
                                    (i = c.model().mainSeries().symbolInfo()) ||
                                void 0 === i
                                    ? void 0
                                    : i.timezone) || p);
                        r.append("timezone", p),
            ...
            async function h(e, t) {
                ...
                try {
                    return (
                        await (0, s.writePromiseUsingApi)(i, "text/plain"), a
                    );
                } catch (e) {
            ...
            async function g(e, t) {
                try {
                    ...
                    throw (
                        (w.logWarn("Error while trying to create snapshot"), e)
                    );
                }
            }
            async function u(e) {
