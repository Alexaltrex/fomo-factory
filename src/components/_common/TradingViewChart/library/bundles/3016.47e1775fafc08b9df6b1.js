        ...
        63016: (t, e, i) => {
            ...
            class D {
                ...
                getDialogsTopLeftCoordinates() {
                    const { clientHeight: t, clientWidth: e } =
                            document.documentElement,
            ...
            class M extends s.PureComponent {
                ...
                componentDidUpdate() {
                    if (this._resize) {
                        const { guard: t, calculateDialogPosition: e } =
                            this.props;
            ...
            function n(t) {
                return class extends s.PureComponent {
                    render() {
                        ...
                        if (!e) return null;
                        const n = s.createElement(t, {
                            ...this.props,
                            zIndex: 150,
                        });
                        return "parent" === i
                            ? n
                            : s.createElement(o.Portal, null, n);
                    }
                };
            }
        },
