        ...
        89324: (e, t, n) => {
            n.r(t),
                n.d(t, {
                    ...
                    showSymbolSearchItemsDialog: () =>
                        r.showSymbolSearchItemsDialog,
                });
            var o = n(82992),
                s = (n(32563), n(38318)),
                i = n(89453),
            ...
            function l(e) {
                const t = (0, i.getSymbolSearchCompleteOverrideFunction)(),
                    ...
                    h = {
                        ...c,
                        showSpreadActions:
                            null != a ? a : (0, s.canShowSpreadActions)(),
                        onSearchComplete: (e) => {
                            t(e[0].symbol).then((e) => {
            ...
            function i(e) {
                ...
                return (
                    (0, o.useLayoutEffect)(() => {
                        ...
                        return (0, s.addOutsideEventListener)(
                            h.current,
                            o,
                            a,
                            d,
        ...
        88216: (e, t, n) => {
            ...
            function a(e = document) {
                ...
                if (null !== t) return (0, o.ensureDefined)(r.get(t));
                {
                    ...
                    return (
                        r.set(n, t), t.setContainer(n), e.body.appendChild(n), t
                    );
                }
            }
        },
