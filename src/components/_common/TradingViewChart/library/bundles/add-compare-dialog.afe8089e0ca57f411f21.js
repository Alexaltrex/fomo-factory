    ...
    [731],
    {
        ...
        89035: (e, t, n) => {
                    ...
                    : o.createElement(
                          ...
                          o.createElement(
                              N,
                              {
                                  ...
                                  isItemSelected: Boolean(n),
                                  isSelected:
                                      n && m === O.CompareOption.NewPriceScale,
                              },
                              P.newPriceScale
                          ),
                          o.createElement(
            ...
            function B(e) {
                ...
                return o.createElement(
                    ...
                    o.createElement(S.SymbolSearchDialogContentItem, {
                        ...
                        onClick: function (t) {
                            if (Boolean(r) && s && !c)
                                return t.preventDefault(), void u(s);
                            if (!D && d) return void k(!0);
                            if (m && e.onClick) return void e.onClick(t);
                            if ((a.mobiletouch ? B : !D) && n) {
                                (0,
                                i.getSymbolSearchCompleteOverrideFunction)()(
                                    n
                                ).then((e) => {
                                    f.applyStudy(
                                        e,
                                        O.CompareOption.SameScale,
                                        M
                                    );
                                }),
                                    b(""),
                                ...
                                return o.createElement(
                                    ...
                                    Boolean(y.length) &&
                                        o.createElement(
                                            ...
                                            y.map((e, t) =>
                                                o.createElement(
                                                    S.SymbolSearchDialogContentItem,
                                                    {
                                                        "data-role":
                                                            "added-symbol-item",
                                                        className: z.item,
                ...
                constructor(e) {
                    super(e),
                        ...
                        (this._toggleAllowExtendTimeScale = () => {
                            ...
                            F.setValue(
                                "showAddSymbolDialog.extendCheckboxState",
                                e
                            ),
                        ...
                        onKeyDown: function (e) {
                            ...
                            switch (s) {
                                ...
                                case 37: {
                                    const n = B();
                                    if (n && t.has(n))
                                        return e.preventDefault(), void l(n);
                                    if (!y || n) return;
                ...
                show() {
                    ...
                    const e = o.createElement(
                        ...
                        o.createElement(Q.SymbolSearchItemsDialog, {
                            ...this._props,
                            initialMode:
                                this._props.initialMode || "symbolSearch",
                            onClose: () => this.hide(),
                        })
                    );
            ...
            var $ = n(81319),
                ...
                te = n(70613);
            function ne(e) {
                const { searchRef: t, setMode: n } = (0, x.useEnsuredContext)(
                        w.SymbolSearchItemsDialogContext
                    ),
            ...
            function se(e) {
                return new K({
                    wrapper:
                        ((t = e),
                        (e) => o.createElement(V, { ...e, compareModel: t })),
                    dialog: U,
                    contentItem: B,
                    initialScreen: W,
                    searchInput: ne,
                    ...
                    dialogWidth: "fixed",
                    onSearchComplete: (t) => {
                        const { compareOption: n, allowExtendTimeScale: o } =
                            t[0];
                        if (void 0 !== n) {
                            (0, i.getSymbolSearchCompleteOverrideFunction)()(
                                t[0].symbol
        ...
        88216: (e, t, n) => {
            ...
            function i(e = document) {
                ...
                if (null !== t) return (0, o.ensureDefined)(l.get(t));
                {
                    ...
                    return (
                        l.set(n, t), t.setContainer(n), e.body.appendChild(n), t
                    );
                }
            }
        },
            ...
            function m(e) {
                ...
                return o.createElement(
                    d,
                    {
                        ...
                        role: n,
                        "aria-selected": c,
                        className: r(m, P.item, b && P.withIcon, {
                            [P.isActive]: w,
                            [P.isDisabled]: S || y,
                            [P.hovered]: C,
                        }),
                        ...
                        onClick: function (t) {
                            ...
                            if (S) return;
                            i &&
                                (0, l.trackEvent)(i.category, i.event, i.label);
                            o && o(r, t);
                    ...
                    c = (0, o.useCallback)(
                        (e) => {
                            t && (t.current = e),
                                l.CheckMobile.iOS() &&
                                    (null !== i.current &&
                                        (0, r.enableBodyScroll)(i.current),
                                    (i.current = e),
                                    null !== i.current &&
