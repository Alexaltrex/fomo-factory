    ...
    [4862],
    {
        ...
        67029: (e, t, n) => {
            ...
            function p(e, t, n, o) {
                const {
                    ...
                    b = h(
                        null != s ? s : (0, c.getGroupCellRemoveRoundBorders)(n)
                    );
                return r(
                    u().container,
                    u()["intent-" + l],
            ...
            const g = {
                    FontSizeMedium: (0, s.ensureDefined)(
                        u()["font-size-medium"]
                    ),
                ...
                const {
                    ...
                    x = (function (e, t = null, n) {
                        const r = (0, o.useRef)(null),
                            s = (0, o.useRef)(null),
                            i = (0, o.useCallback)(() => {
                                if (null === r.current || null === s.current)
                                    return;
                ...
                const {
                    ...
                    I = (0, i.createSafeMulticastEventHandler)(
                        ...
                        function (e) {
                            n &&
                                !C.current &&
                                (0, l.selectAllContent)(e.currentTarget);
                        },
                        s
                    ),
            ...
            class C extends o.PureComponent {
                            ...
                            if (this._model && this._symbolDrawingsMap) {
                                ...
                                if (t) {
                                    const n = Array.from(t)
                                        .map((e) =>
                                            (0, r.ensureNotNull)(this._model)
                                                .model()
                                                .dataSourceForId(e)
                                        )
                                        .filter(p.notNull);
                                    n.length > 0 &&
                                        this._model.removeSources(
                                            n,
                                            !1,
                                            _.format({ symbol: e })
                                        ),
                ...
                render() {
                    ...
                    return o.createElement(
                        ...
                        n &&
                            n.length > 0 &&
                            o.createElement("div", { className: v.title }, s),
                        null === n || 0 === n.length
                            ...
                            : n.map((n) =>
                                  o.createElement(h.DialogContentItem, {
                                      ...
                                      isActive: n.symbol === t,
                                      isMobile: e,
                                      onClick: this._onItemClick.bind(
                                          this,
                                          n.symbol
                                      ),
                                      onClickRemove: this._onRemove.bind(
                                          this,
                                          n.symbol
                                      ),
                                      showFavorite: !1,
        ...
        49469: (e, t, n) => {
            ...
            var k = n(14593),
                ...
                P = n(51768);
            function j(e) {
                const { viewModel: t } = (0, I.ensureNotNull)(
                        (0, o.useContext)(N)
                    ),
                ...
                return o.createElement(
                    ...
                    o.createElement(
                        "div",
                        { className: E(F.title, F.withoutIcon) },
                        (0, v.t)("Object tree"),
                        !1
                    ),
                    o.createElement(
            ...
            function Ye(e, t, n) {
                ...
                for (const r of t.children) {
                    const t = e[r];
                    void 0 !== t &&
                        (o.push(t), n.has(r) && o.push(...Ye(e, t, n)));
                }
                return o;
            }
            function* et(e) {
                ...
                yield (0, w.put)(((e) => ({ type: Z, nodes: e }))(o)),
                    yield (0, w.put)(Ce(t));
                !Ue(yield (0, w.select)()) &&
                    t.length > 0 &&
                    (yield (0, w.put)(Ee(t[0])), yield (0, w.put)(Me(t[0])));
            }
            function* tt(e) {
                for (;;) {
                    if ((yield (0, w.take)([le, ae])).type === le) {
                        const t = Ge(yield (0, w.select)()).filter(
                            (t) => !e(t)
                        );
                        yield (0, w.put)(Ae(t));
            ...
            function* nt() {
                for (;;) {
                    ...
                    if ((e === ne && 0 === l) || (e === oe && l === o - 1))
                        continue;
                    const a = ct(t, e === oe ? "next" : "previous", n, l),
                        { id: c } = a;
                    s.includes(c) && r
                        ? (yield (0, w.put)(xe(r, !1, 1)),
                          yield (0, w.put)(Ee(c)))
            ...
            function* dt(e = {}) {
                ...
                for (
                    t && c.push((0, w.fork)(t)),
                        r && c.push((0, w.fork)(at, r)),
                        a && c.push((0, w.fork)(tt, a));
                    ;
                    ...
                    switch (t.type) {
                        case J: {
                            ...
                            return {
                                ...
                                ids: n,
                                lastFocusedNodeId:
                                    n.length > 0 ? e.lastFocusedNodeId : void 0,
                            };
                        }
                        case le:
            ...
            const Lt = (e) => {
                    const {
                        ...
                        { size: v, smallSizeTreeNodeAction: _ } = (0,
                        o.useContext)(It),
                        b = (0, o.useRef)(null),
                        S = (0, wt.createSafeMulticastEventHandler)(
                            (e) => (b.current = e),
                            h
                        );
                    ...
                    return (
                        (bt.CheckMobile.any() || bt.CheckMobile.isIPad()) &&
                            ((y = n),
                            (C = { onMouseOut: Dt, onMouseOver: Dt })),
                        o.createElement(
                            "div",
                            {
                                className: E(
            ...
            function Gt(e) {
                ...
                const { x: o, y: r } = t,
                    s = n && t ? n.y - t.y : 0,
                    i = `translate(${o + (n && t ? n.x - t.x : 0)}px, ${
                        r + s
                    }px)`;
            ...
            const Yt = (0, zt.DragLayer)(function (e) {
                ...
                en = o.forwardRef((e, t) => {
                    ...
                    return o.createElement(
                        ...
                        e.children,
                        n.isOver &&
                            o.createElement(Yt, { transform: n.transform })
                    );
                });
            var tn = n(62820),
                nn = n(34244);
            ...
            const sn = o.forwardRef(function (e, t) {
                    ...
                    (0, o.useEffect)(() => {
                        const e = (e) => {
                                [Ct.Modifiers.Mod, Ct.Modifiers.Shift].includes(
                                    (0, Ct.modifiersFromEvent)(e)
                                ) && i();
                            },
                            t = (e) => {
                                l &&
                                    ![
                                        Ct.Modifiers.Mod,
                                        Ct.Modifiers.Shift,
                                    ].includes((0, Ct.modifiersFromEvent)(e)) &&
                                    s();
                            };
                        return (
                    ...
                    const R = (0, o.useCallback)((e) => {
                        ...
                        P = (0, o.useCallback)(
                            (e) => (0, I.ensure)(B.current[e].node.key),
                            []
                        ),
                        j = (0, o.useMemo)(
                            () =>
                    ...
                    (0, o.useEffect)(
                        () =>
                            (0, I.ensureNotNull)(W.current).resetAfterIndex(
                                0,
                                !0
                            ),
                        [O]
                        ...
                        (0, o.useEffect)(
                            () =>
                                (0, I.ensureNotNull)(W.current).scrollToItem(
                                    j.index
                                ),
                            [j]
                        );
                    const U = (0, o.useRef)(null),
                        ...
                        Q = (0, o.useRef)({
                            startScroll(e) {
                                const t = () => {
                                    null !== H.current &&
                                        ((Z.current = requestAnimationFrame(t)),
                                        H.current.scrollBy({ top: e }));
                                };
                                this.stopScroll(), t();
                            },
                            stopScroll() {
                    ...
                    return (
                        ...
                        o.createElement(
                            ...
                            o.createElement(
                                ...
                                o.createElement(Kt.OverlayScrollContainer, {
                                    ...z,
                ...
                ln = (0, vt.DropTarget)(
                    ...
                    {
                        drop: (e, t, n) => {
                            ("touch" === e.drag || bt.isFF) && n.stopScroll(),
            ...
            function dn(e) {
                ...
                return (
                    ...
                    null === m
                        ? null
                        : o.createElement(un, { store: m, scrollToId: f, ...g })
                );
            }
            ...
            function* mn() {
                for (;;) {
                    ...
                    1 === e && hn("Multi select", "Ctrl"),
                        2 === e && hn("Multi select", "Shift");
                }
            }
            function* vn(e) {
                for (;;) {
                    ...
                    if (t) {
                        const o = Ze(yield (0, w.select)()),
                            r = o.map((t) =>
                                (0, I.ensureNotNull)(e.entity(t.id))
                            );
                        let s = "Drag";
                        1 === t.level &&
                        "inside" !== n &&
            ...
            function* bn(e) {
                ...
                try {
                    ...
                    pt.logNormal("Closed object tree data source channel"),
                        t.close();
                }
            }
                                ...
                                o.createElement(
                                    ...
                                    null !== c &&
                                        o.createElement(dn, {
                                            ...
                                            height: c.height,
                                            width: c.width,
                                            canBeAddedToSelection: function (
                                                e
                                            ) {
                                                const n = t.entity(e);
                                                return t
                                                    .selection()
                                                    .canBeAddedToSelection(n);
                                            },
                                            nodeRenderer: r,
                                            initState: function () {
                                                const {
            ...
            function An(e) {
                ...
                return o.createElement(x.Icon, {
                    className: M()(Dn.button, n && Dn.disabled, t),
                    ...r,
                });
            }
            var Ln = n(77975),
            ...
            function zn(e) {
                ...
                (0, o.useEffect)(() => {
                    ...
                    c.onLockChanged().subscribe(e, () => C(c.isLocked())),
                        c
                            .onVisibilityChanged()
                            .subscribe(e, () => T(c.isVisible()));
                    const t = c.onTitleChanged();
                    return (
                        t && t.subscribe(e, () => S(c.title())),
                        c
                            .onIsActualIntervalChange()
                            .subscribe(e, () => D(c.isActualInterval())),
                        c
                            .onSyncStateChanged()
                            .subscribe(e, () => L(c.getDrawingSyncState())),
                        () => {
                    ...
                    (0, o.useEffect)(() => {
                        g &&
                            _.current &&
                            (_.current.focus(),
                            _.current.setSelectionRange(0, b.length));
                    }, [g]),
                    (0, o.useEffect)(() => {
                        const e = {};
                        return (
                ...
                if (a) {
                    const e = h.entity(a);
                    e && (j["data-parent-name"] = e.title()),
                        (j["data-type"] = c.hasChildren()
                            ? "group"
                            : "data-source");
                }
                const z = c.title(),
                ...
                return o.createElement(
                    "span",
                    {
                        ...
                        onMouseDown: function (e) {
                            g &&
                                !(0, I.ensureNotNull)(_.current).contains(
                                    e.target
                                ) &&
                                R(!0);
                        },
                        onClick:
                            1 === f
                                ...
                                : function (e) {
                                      if (e.defaultPrevented) return;
                                      if (0 !== (0, Ct.modifiersFromEvent)(e))
                                          return;
                                      if (F.current)
                                          e.preventDefault(),
                    ...
                    !H &&
                        o.createElement(
                            ...
                            P &&
                                ...
                                o.createElement(
                                    "span",
                                    { className: E(Pn.icon, Pn.textIcon) },
                                    P.content
                                ),
                            !1,
                            o.createElement(
                            ...
                            o.createElement(
                                ...
                                o.createElement(An, {
                                    ...
                                    className: E(
                                        Pn.button,
                                        !M && [Pn.warn, "apply-common-tooltip"],
                                        (V || !w || !M) && Pn.visible
                                    ),
                                    onClick: M
                                        ? function (e) {
            ...
            class Hn extends o.PureComponent {
                    ...
                    super(e),
                        ...
                        (this._handleMediaChange = () => {
                            this.state.showDrawer &&
                                !window.matchMedia(
                                    b.DialogBreakpoints.TabletSmall
                                ).matches &&
                ...
                componentWillUnmount() {
                    (this._isMounted = !1),
                        this._matchMedia.removeListener(
                            this._handleMediaChange
                        ),
                        this.props.viewModel
                            .isContextMenuOpened()
                ...
                render() {
                    return o.createElement(
                        ...
                        o.createElement(
                            m.MatchMedia,
                            { rule: b.DialogBreakpoints.TabletSmall },
                            (e) =>
            ...
            class qn {
                constructor(e) {
                    (this._onChange = new (Zn())()),
                        ...
                        this._groupModel
                            .onChanged()
                            .subscribe(this, this._recalculate);
                }
                destroy() {
            ...
            class Jn {
                ...
                buildTree() {
                    ...
                    for (const t of this._controller.model().panes()) {
                        ...
                        for (const n of this._groupModel.groups()) {
                            const o = Xn(n.id, n.instanceId()),
                                r = (0, I.ensureNotNull)(
                                    this._facade.getObjectById(o)
                                );
                            if (r.pane() === t) {
                                const o = [...n.lineTools()]
                                    .sort((e, t) =>
                                        e.zorder() > t.zorder() ? -1 : 1
                                    )
                                    .map((e) => Xn(e.id(), e.instanceId()));
                                (e[r.id()] = Yn(r.id(), 1, t.id(), o)),
                        ...
                        for (const o of n) {
                            ...
                            e[n] ||
                                ((e[n] = Yn(n, 1, t.id())),
                                e[t.id()].children.push(n));
                        }
                        e[t.id()].children.sort((e, t) => {
                            const n = (0, I.ensureNotNull)(
                                    this._facade.getObjectById(e)
                                ),
                                o = (0, I.ensureNotNull)(
                                    this._facade.getObjectById(t)
                                );
                            return (
                    ...
                    return (
                        this._facade.invalidateCache(new Set(Object.keys(e))), e
                    );
                }
            }
            function Yn(e, t, n, o = []) {
            ...
            var eo = n(24980),
                ...
                co = n(28337),
                uo = n(46627);
            const ho = new eo.TranslatedString(
                    "show {title}",
                    (0, v.t)("show {title}")
                ),
                po = new eo.TranslatedString(
                    "hide {title}",
                    (0, v.t)("hide {title}")
                ),
                fo = new eo.TranslatedString(
                    "lock {title}",
                    (0, v.t)("lock {title}")
                ),
                go = new eo.TranslatedString(
                    "unlock {title}",
                    (0, v.t)("unlock {title}")
                ),
                ...
                vo = new eo.TranslatedString(
                    "insert source(s) after",
                    (0, v.t)("insert source(s) after")
                );
            function _o(e, t) {
                return t.every(
            ...
            function bo(e) {
                return e instanceof oo.DataSource && e.showInObjectTree()
                    ? Xn(e.id(), e.instanceId())
                    : null;
            }
            function So(e) {
            ...
            class Co {
                constructor(e, t) {
                    (this._syncStateChanged = new (Zn())()),
                        (this._lineToolsAffectChartInvalidation =
                            new uo.FeatureToggleWatchedValue(
                        ...
                        (0, to.isLineTool)(this._dataSource) &&
                            (this._dataSource
                                .linkKey()
                                .subscribe(this._updateSyncState),
                            this._dataSource
                                .sharingMode()
                                .subscribe(this._updateSyncState));
                    ...
                    null !== n &&
                        n === t &&
                        n.isSynchronizable() &&
                        io.isToolCreatingNow.subscribe(this._updateSyncState);
                }
                destroy() {
                    (0, to.isLineTool)(this._dataSource) &&
                        (this._dataSource
                            .linkKey()
                            .unsubscribe(this._updateSyncState),
                        this._dataSource
                            .sharingMode()
                            .unsubscribe(this._updateSyncState)),
                ...
                fullyConstructed() {
                    return (
                        this._undoModel.lineBeingCreated() !== this._dataSource
                    );
                }
                isVisible() {
                ...
                getIcon() {
                    ...
                    if (e && t)
                        if ("loadSvg" === t.type) {
                            ...
                            "text" === t.type &&
                                (o = { type: Mn.Text, content: t.text });
                    return o;
                }
                setVisible(e) {
                    const t = (e ? ho : po).format({
                        title: So(this._dataSource),
                    });
                ...
                detachFromParent() {
                    if ((0, to.isLineTool)(this._dataSource)) {
                        ...
                        null !== n &&
                            t.excludeLineToolFromGroup(n, this._dataSource);
                    }
                }
                onTitleChanged() {
                ...
                setDrawingSyncState(e) {
                    if (!this.canBeSyncedInLayout() || !this.fullyConstructed())
                        return;
                    ...
                    if ((0, to.isLineTool)(this._dataSource)) {
                        ...
                        null !== t
                            ? ((0, I.assert)(!e.some((e) => e.hasChildren())),
                              s.forEach((e) => {
                                  (0, to.isLineTool)(e) &&
                                      (t.containsLineTool(e) ||
                                          o.addLineToolToGroup(t, e));
                              }))
                            : r();
                    } else r();
            ...
            class wo {
                constructor(e, t) {
                    (this._onTitleChanged = new (Zn())()),
                        ...
                        (this._syncStateChanged = new (Zn())()),
                        (this._linkKeyChangedBound =
                            this._linkKeyChanged.bind(this)),
                        (this._lineToolsAffectChartInvalidation =
                            new uo.FeatureToggleWatchedValue(
                                "do_not_invalidate_chart_on_changing_line_tools",
                                !1
                ...
                isVisible() {
                    return (
                        this._group.lineTools().length > 0 &&
                            (this._lastIsVisible =
                                "Invisible" !== this._group.visibility()),
                        this._lastIsVisible
                    );
                }
                isActualInterval() {
                ...
                zOrder() {
                    return (
                        this._group.lineTools().length > 0 &&
                            (this._lastActualZOrder = this._group
                                .lineTools()[0]
                                .zorder()),
                ...
                insertSourcesBeforeThis(e) {
                    ...
                    this._insertSources(e, (e) =>
                        this._undoModel.insertBefore(e, t)
                    );
                }
                insertSourcesAfterThis(e) {
                    const t = this._insertAfterTarget();
                    this._insertSources(e, (e) =>
                        this._undoModel.insertAfter(e, t)
                    );
                }
                childrenIds() {
                    ...
                    return (
                        ...
                        new Set(e.map((e) => Xn(e.id(), e.instanceId())))
                    );
                }
                hasChildren() {
                    return !0;
                ...
                canBeSyncedInLayout() {
                    return (
                        ...
                        this._lineTools[0].isSynchronizable()
                    );
                }
                onSyncStateChanged() {
                    return this._syncStateChanged;
            ...
            class To {
                ...
                canBeGroupped(e) {
                    ...
                    if (
                        ...
                        t.some(
                            (e) => !(0, to.isLineTool)(e) || !e.boundToSymbol()
                        ))
                    )
                        return !1;
                    const n = this._undoModel.model(),
            ...
            const Fo = new eo.TranslatedString(
                    "move objects",
                    (0, v.t)("move objects")
                ),
                Po = new eo.TranslatedString(
                ...
                jo = new eo.TranslatedString(
                    "unlock objects",
                    (0, v.t)("unlock objects")
                ),
                zo = new eo.TranslatedString(
                    "show objects",
                    (0, v.t)("show objects")
                ),
                Vo = new eo.TranslatedString(
                ...
                Ho = new eo.TranslatedString(
                    "remove objects",
                    (0, v.t)("remove objects")
                ),
            ...
            class $o {
                    ...
                    (this._nodes = {}),
                        ...
                        (this._init = () => {
                            ...
                            e.hasModel() &&
                                ...
                                (this._groupModel =
                                    this._model.lineToolsGroupModel()),
                ...
                isMain(e) {
                    return (
                        $n(e.id()).persistentId ===
                        this._controller.mainSeries().id()
                    );
                }
                selection() {
                ...
                remove(e) {
                    const t = () => {
                            const e = n.every((e) =>
                                e.doNotAffectChartInvalidation()
                            );
                            this._controller.withMacro(
                                Ho,
                                () => {
                ...
                openProperties(e, t) {
                    const n = this._model.dataSourceForId(
                        $n(e.id()).persistentId
                    );
                ...
                canSelectionBeUnmerged() {
                    ...
                    return (
                        1 === e.length &&
                        this.canNodeWithIdBeUnmerged($n(e[0].id()).persistentId)
                    );
                }
                ...
                async openContextMenu(e, t, n) {
                    ...
                    if (s.length > 0) {
                        ...
                        (a = i
                            ...
                            Eo.ContextMenuManager.showMenu(
                                s,
                                n,
                ...
                getNextNodeIdAfterRemove(e) {
                    ...
                    const { nodes: n } = this.getState(),
                        ...
                        r = n.find((t) => t.id === e),
                        s = this.entity(e);
                    if (!(r && r.parentId && s && s.canBeRemoved()))
                        return null;
                    if (
                        (null === (t = s.pane().mainDataSource()) ||
                        void 0 === t
                            ? void 0
                            : t.id()) === o &&
                        ...
                        return (0, I.ensureDefined)(n.find((e) => e.id === t))
                            .children[0];
                    }
                ...
                _getActionsForGroupItem(e, t, n) {
                    ...
                    const r = [];
                    1 === this._objects.length &&
                        r.unshift(this._getRenameAction(t), new Mo.Separator()),
                        n &&
                            r.unshift(
                                this._getGroupAction(),
                                new Mo.Separator()
                            );
                    const s = (0, so.createSyncDrawingActions)(
                        this._chart.value(),
                        o.filter(to.isLineTool)
                    );
                    return (
                        s.length &&
                            (s.shift(),
                            s.push(new Mo.Separator()),
                            r.push(...s)),
                        r.push(
                            new Mo.Action({
                                ...
                                onExecute: () =>
                                    this.setIsLocked(e.id(), !e.isLocked()),
                            }),
                            new Mo.Action({
                                ...
                                onExecute: () =>
                                    this.setIsVisible(e.id(), !e.isVisible()),
                            }),
                            new Mo.Action({
                ...
                _unmergeSelection(e) {
                    ...
                    const n = t[0],
                        o = (0, I.ensureNotNull)(
                            this._model.dataSourceForId($n(n.id()).persistentId)
                        );
                    if (!(0, Io.isPriceDataSource)(o))
                ...
                _getSelectedEntities() {
                    const { selected: e, removed: t } = this._selection
                        .selected()
                        .reduce(
                            (e, t) => {
            ...
            class Jo extends qo.DialogRenderer {
                constructor() {
                    ...
                    const e = (0, Wn.service)(
                        Un.CHART_WIDGET_COLLECTION_SERVICE
                    );
                    (this._activeChartWidget = e.activeChartWidget.value()),
                        (this._viewModel = new $o(e.activeChartWidget));
                }
                hide() {
                    this._handleClose();
                }
        ...
        61074: (e, t, n) => {
            ...
            function i(e) {
                const t = r(
                    ...
                    "tv-spinner--shown",
                    "tv-spinner--size_" +
                        s.spinnerSizeMap[e.size || s.DEFAULT_SIZE]
                );
                return o.createElement("div", {
                    className: t,
                    style: e.style,
