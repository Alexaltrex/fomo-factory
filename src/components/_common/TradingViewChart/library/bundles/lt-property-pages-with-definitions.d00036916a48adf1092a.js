    ...
    [8537],
    {
        ...
        23206: (e, t, i) => {
            ...
            const a = new l.TranslatedString(
                ...
                d = new l.TranslatedString(
                    "backgrounds color",
                    (0, r.t)("backgrounds color")
                ),
                h = new l.TranslatedString(
                    "backgrounds filled",
                    (0, r.t)("backgrounds filled")
                ),
                g = new l.TranslatedString(
                    "text color",
                    (0, r.t)("text color")
                );
            function y(e, t) {
                    ...
                    const l = (0, s.createLinePropertyDefinition)(
                        {
                            width: e.linesWidths
                                ? new o.CollectiblePropertyUndoWrapper(
                                      new n.LineToolCollectedProperty(
                                          e.linesWidths
                                      ),
                                      a,
                                      t
            ...
            function M(e, t, i, r) {
                ...
                const B = (0, l.createCheckablePropertyDefinition)(
                    ...
                    },
                    {
                        ...
                        title: (r && r.showPriceLabelsTitle) || _,
                    }
                );
                s.push(B);
                const N = [],
        ...
        73642: (e, t, i) => {
            ...
            function b(e, t, i, r, n) {
                ...
                return (
                    void 0 !== t.showLine &&
                        (b.checked = (0, o.convertToDefinitionProperty)(
                            e,
                            t.showLine,
                            s.format({ toolName: i })
                        )),
                    void 0 !== t.lineWidth &&
                        (b.width = (0, o.convertToDefinitionProperty)(
                            e,
                            t.lineWidth,
                            a.format({ toolName: i })
                        )),
                    void 0 !== t.lineStyle &&
                        (b.style = (0, o.convertToDefinitionProperty)(
                            e,
                            t.lineStyle,
                            c.format({ toolName: i })
                        )),
                    void 0 !== t.lineColor &&
                        (b.color = (0, o.getColorDefinitionProperty)(
                            e,
                            t.lineColor,
                            null,
                            p.format({ toolName: i })
                    ...
                    void 0 !== t.extendLeft &&
                        ((b.extendLeft = (0, o.convertToDefinitionProperty)(
                            e,
                            t.extendLeft,
                            d.format({ toolName: i })
                        )),
                    ...
                    void 0 !== t.leftEnd &&
                        (b.leftEnd = (0, o.convertToDefinitionProperty)(
                            e,
                            t.leftEnd,
                            h.format({ toolName: i })
                        )),
                    void 0 !== t.extendRight &&
                        ((b.extendRight = (0, o.convertToDefinitionProperty)(
                            e,
                            t.extendRight,
                            g.format({ toolName: i })
                        )),
                    ...
                    void 0 !== t.rightEnd &&
                        (b.rightEnd = (0, o.convertToDefinitionProperty)(
                            e,
                            t.rightEnd,
                            y.format({ toolName: i })
                        )),
        ...
        59278: (e, t, i) => {
            ...
            function S(e, t, i, r) {
                ...
                if (
                    (void 0 !== t.showText &&
                        (n.checked = (0, o.convertToDefinitionProperty)(
                            e,
                            t.showText,
                            s.format({ toolName: i })
                        )),
                    ...
                    void 0 !== t.fontSize &&
                        (n.size = (0, o.convertToDefinitionProperty)(
                            e,
                            t.fontSize,
                            c.format({ toolName: i })
                        )),
                    void 0 !== t.bold &&
                        (n.bold = (0, o.convertToDefinitionProperty)(
                            e,
                            t.bold,
                            p.format({ toolName: i })
                        )),
                    void 0 !== t.italic &&
                        (n.italic = (0, o.convertToDefinitionProperty)(
                            e,
                            t.italic,
                            d.format({ toolName: i })
                        )),
                    void 0 !== t.text &&
                        ((n.text = (0, o.convertToDefinitionProperty)(
                            e,
                            t.text,
                            h.format({ toolName: i })
                        )),
                    ...
                    void 0 !== t.vertLabelsAlign &&
                        ((n.alignmentVertical = (0,
                        o.convertToDefinitionProperty)(
                            e,
                            t.vertLabelsAlign,
                            g.format({ toolName: i })
                        )),
                    ...
                    void 0 !== t.horzLabelsAlign &&
                        ((n.alignmentHorizontal = (0,
                        o.convertToDefinitionProperty)(
                            e,
                            t.horzLabelsAlign,
                            y.format({ toolName: i })
                        )),
                        (S.alignmentHorizontalItems =
                            r.alignmentHorizontalItems)),
                    void 0 !== t.textOrientation &&
                        (n.orientation = (0, o.convertToDefinitionProperty)(
                            e,
                            t.textOrientation,
                            f.format({ toolName: i })
                        )),
                    void 0 !== t.backgroundVisible &&
                        (n.backgroundVisible = (0,
                        o.convertToDefinitionProperty)(
                            e,
                            t.backgroundVisible,
                            u.format({ toolName: i })
                    ...
                    void 0 !== t.backgroundTransparency &&
                        ...
                        (n.backgroundColor = (0, o.getColorDefinitionProperty)(
                            e,
                            t.backgroundColor,
                            r,
                            v.format({ toolName: i })
                ...
                return (
                    (void 0 === t.backgroundVisible &&
                        ...
                        (S.backgroundTitle =
                            (r.customTitles &&
                                r.customTitles.backgroundTitle) ||
                            _),
                    void 0 !== t.borderVisible &&
                        (n.borderVisible = (0, o.convertToDefinitionProperty)(
                            e,
                            t.borderVisible,
                            b.format({ toolName: i })
                        )),
                    void 0 !== t.borderWidth &&
                        (n.borderWidth = (0, o.convertToDefinitionProperty)(
                            e,
                            t.borderWidth,
                            D.format({ toolName: i })
                        )),
                    void 0 !== t.borderColor &&
                        (n.borderColor = (0, o.getColorDefinitionProperty)(
                            e,
                            t.borderColor,
                            null,
                            T.format({ toolName: i })
                    ...
                    (void 0 === t.borderVisible &&
                        ...
                        void 0 === t.borderWidth) ||
                        (S.borderTitle =
                            (r.customTitles && r.customTitles.borderTitle) ||
                            P),
                    void 0 !== t.wrap &&
                        ((n.wrap = (0, o.convertToDefinitionProperty)(
                            e,
                            t.wrap,
                            w.format({ toolName: i })
                        )),
                        (S.wrapTitle =
                            (r.customTitles && r.customTitles.wrapTitle) || m)),
        ...
        66819: (e, t, i) => {
            i.r(t),
                i.d(t, {
                    CyclicAndSineLinesPatternDefinitionsViewModel: () => a,
                });
            var r = i(28353),
                n = i(24980),
                o = i(73642),
        ...
        9948: (e, t, i) => {
            ...
            const d = new o.TranslatedString(
                ...
                h = new o.TranslatedString(
                    ...
                    (0, n.t)("change {title} levels visibility")
                ),
                ...
                u = new o.TranslatedString(
                    ...
                    (0, n.t)("change {title} all lines color")
                ),
            ...
            class $ extends a.LineDataSourceDefinitionsViewModel {
                ...
                _stylePropertyDefinitions() {
                    ...
                    const p = t.levelsStyle.childs(),
                        ...
                        I = { line: k };
                    "extendLines" in t &&
                        (($.extendRight = t.extendLines),
                        (I.extendRightTitle = A)),
                        "extendLinesLeft" in t &&
                            (($.extendLeft = t.extendLinesLeft),
                            (I.extendLeftTitle = M)),
                        "extendRight" in t &&
                            (($.extendRight = t.extendRight),
                            (I.extendRightTitle = L)),
                        "extendLeft" in t &&
                            (($.extendLeft = t.extendLeft),
                            (I.extendLeftTitle = C));
                    ...
                    if (
                        ...
                        const i = (0, s.createCheckablePropertyDefinition)(
                            {
                                disabled: (0,
                                s.convertFromWVToDefinitionProperty)(
                                    this._propertyApplier,
        ...
        17770: (e, t, i) => {
            i.r(t),
                i.d(t, { FibSpeedResistanceArcsDefinitionsViewModel: () => S });
            var r = i(88537),
                n = i(28353),
                o = i(24980),
                l = i(73642),
        ...
        51697: (e, t, i) => {
            i.r(t),
                i.d(t, { FibSpeedResistanceFanDefinitionsViewModel: () => z });
            var r = i(88537),
                n = i(28353),
                o = i(24980),
                l = i(50366),
            ...
            const p = new o.TranslatedString(
                ...
                w = new o.TranslatedString(
                    ...
                    (0, n.t)("change {title} grid visibility")
                ),
                _ = new o.TranslatedString(
                    "change {title} grid line color",
                    (0, n.t)("change {title} grid line color")
                ),
                P = new o.TranslatedString(
                    "change {title} grid line width",
                    (0, n.t)("change {title} grid line width")
                ),
                m = new o.TranslatedString(
                    "change {title} grid line style",
                    (0, n.t)("change {title} grid line style")
                ),
            ...
            class z extends s.LineDataSourceDefinitionsViewModel {
                _stylePropertyDefinitions() {
                    ...
                    const R = (0, l.createPropertyDefinitionsLeveledLinesGroup)(
                        ...
                        F = (0, l.createPropertyDefinitionsGeneralGroup)(
                            [R, E, G],
                            n + "HLevelGroup",
                            k
                        );
                    ...
                    const $ = (0, l.createPropertyDefinitionsLeveledLinesGroup)(
                            O,
                            ...
                            (0, o.createLinePropertyDefinition)(
                                {
                                    ...
                                    style: (0, o.convertToDefinitionProperty)(
                                        this._propertyApplier,
                                        e.linestyle,
                                        p.format({ title: r })
                                    ),
        ...
        45384: (e, t, i) => {
            ...
            const h = new o.TranslatedString(
                ...
                T = new o.TranslatedString(
                    ...
                    (0, n.t)("change {title} labels visibility")
                ),
                w = new o.TranslatedString(
                    "change {title} labels alignment",
                    (0, n.t)("change {title} labels alignment")
        ...
        58026: (e, t, i) => {
            ...
            const p = new o.TranslatedString(
                ...
                w = new o.TranslatedString(
                    ...
                    (0, n.t)("change {title} fans visibility")
                ),
                _ = new o.TranslatedString(
                    "change {title} fans line color",
                    (0, n.t)("change {title} fans line color")
                ),
        ...
        80447: (e, t, i) => {
            i.r(t),
                i.d(t, { GeneralDatePriceRangeDefinitionsViewModel: () => m });
            var r = i(28353),
                n = i(24980),
                o = i(73642),
                l = i(59278),
                ...
                _stylePropertyDefinitions() {
                    ...
                    const x = (0, l.createTextStyleDefinition)(
                        ...
                        s,
                        {
                            isEditable: !0,
                            isMultiLine: !0,
                            customTitles: { text: _, backgroundTitle: P },
                        }
                    );
        ...
        14145: (e, t, i) => {
            i.r(t),
                i.d(t, { GeneralTrendFiguresDefinitionsViewModel: () => y });
            var r = i(28353),
                n = i(24980),
                o = i(73642),
                l = i(59278),
                    ...
                    return {
                        definitions: [
                            ...
                            (0, a.createColorPropertyDefinition)(
                                ...
                                {
                                    id: (0, c.removeSpaces)(t + "Background"),
                                    title: g,
                                }
                            ),
                        ],
                    ...
                    return {
                        definitions: [
                            (0, s.createColorPropertyDefinition)(
                                ...
                                {
                                    id: (0, a.removeSpaces)(t + "LabelColor"),
                                    title: p,
                                }
                            ),
                        ],
        ...
        93262: (e, t, i) => {
            i.r(t),
                i.d(t, { PatternWithBackgroundDefinitionViewModel: () => f });
            var r = i(28353),
                n = i(24980),
                o = i(73642),
                l = i(59278),
        ...
        98890: (e, t, i) => {
            i.r(t),
                i.d(t, {
                    PatternWithoutBackgroundDefinitionsViewModel: () => p,
                });
            var r = i(28353),
                n = i(24980),
                o = i(73642),
            ...
            class H extends s.LineDataSourceDefinitionsViewModel {
                constructor(e, t) {
                    ...
                    (this._riskMaxWV = new (d())(this._getRiskMax(r))),
                        ...
                        (this._riskPrecisionWV = new (d())(
                            this._getRiskPrecision(r)
                        )),
                        (this._riskUnitWV = new (d())(this._getRiskUnit())),
                        (this._riskUnitOptionsWV = new (d())(
                            this._getRiskUnitOptions()
                        )),
                        (this._lotSizeStepWV = new (d())(
                            this._getLotSizeStep()
                        )),
                        this._createPropertyRages(),
                        i.riskDisplayMode.subscribe(this, (e) =>
                            this._onRiskDisplayChanged(e)
                        ),
                        i.accountSize.subscribe(this, () =>
                            this._onAccountSizeChanged()
                        ),
                        i.lotSize.subscribe(this, () =>
                            this._onLotSizeChanged()
                        ),
                        this._undoModel
                            .model()
                            .mainSeries()
                        ...
                        f = (0, a.createNumberPropertyDefinition)(
                            {
                                value: (0, a.convertToDefinitionProperty)(
                                    ...
                                    [
                                        (e) => e,
                                        (e) =>
                                            this._source.preparseProfitPrice(e),
                                    ]
                                ),
                            },
                            {
                                id: i + "ProfitLevelPrice",
                                title: B,
                                type: 1,
                                step: o,
                            }
                        ),
                        u = (0, a.createPropertyDefinitionsGeneralGroup)(
                            [y, f],
                            i + "ProfitLevel",
                            z
                        ),
                        ...
                        k = (0, a.createNumberPropertyDefinition)(
                            {
                                value: (0, a.convertToDefinitionProperty)(
                                    ...
                                    [
                                        (e) => e,
                                        (e) =>
                                            this._source.preparseStopPrice(e),
                                    ]
                                ),
                            },
                            {
                ...
                _onRiskDisplayChanged(e) {
                    ...
                    this._riskMaxWV.setValue(this._getRiskMax(t)),
                        ...
                        this._riskPrecisionWV.setValue(
                            this._getRiskPrecision(t)
                        );
                }
                ...
                _onSymbolInfoChanged() {
                    this._riskUnitWV.setValue(this._getRiskUnit()),
                        this._riskUnitOptionsWV.setValue(
                            this._getRiskUnitOptions()
                        );
                }
                _getRiskMax(e) {
        ...
        30882: (e, t, i) => {
            ...
            const h = new n.TranslatedString(
                ...
                u = (0, r.t)("#1 (vertical position %, bar)", {
