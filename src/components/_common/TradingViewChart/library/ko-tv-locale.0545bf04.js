...
_tv_languages.ko = {
    ...
    "Link to the chart image copied to clipboard {emoji}":
        "차트 이미지 링크가 클립보드에 복사됨 {emoji}",
    "Chart image copied to clipboard {emoji}":
        "차트 이미지가 클립보드에 복사됨 {emoji}",
    Baseline: "베이스라인",
    Units: "유닛",
    Reverse: "리버스",
    Yes: "예",
    ...
    "Main symbol data is adjusted for dividends only":
        "메인 심볼 데이터는 디비든드에 대해서만 조정됩니다",
    "Main symbol data is adjusted for splits only":
        "메인 심볼 데이터는 스플릿에 대해서만 조정됩니다",
    ...
    "Add indicator/strategy on {studyTitle}":
        "{studyTitle} 에 인디케이터/스트래티지 넣기",
    "Add financial metric for {instrumentName}":
        "{instrumentName} 의 파이낸셜 메트릭 넣기",
    ...
    "More features on tradingview.com":
        "Tradingview.com 에 있는 더욱 더 많은 기능들",
    "move left": "왼쪽으로 옮기기",
    ...
    "{userName} published on {customer}, {date}":
        "{userName} 이 {customer}, {date} 에 퍼블리쉬했음",
    ...
    "change baseline fill top area color":
        "베이스라인 필 탑 에어리어 컬러 바꾸기",
    "change baseline fill bottom area color":
        "베이스라인 필 바텀 에어리어 컬러 바꾸기",
    ...
    "change {title} fib levels based on log scale":
        "로그 스케일을 기반으로 {title}의 피보나치 레벨 변경",
    "Levels line": "레벨 라인",
    ...
    "change {sourceTitle} title to {newSourceTitle}":
        "{sourceTitle} 타이틀을 {newSourceTitle} 으로 바꾸기",
    ...
    "Group is hidden on current interval":
        "현재 인터벌에 대해 그룹이 감춰져 있습니다",
    "Drawing is hidden on current interval":
        "커런트 인터벌에서는 드로잉이 숨겨져 있습니다",
    ...
    'Set the "{inputTitle}" time for "{studyShortDescription}"':
        "{studyShortDescription}에 대한 {inputTitle} 시간 설정",
    'Set the time for "{studyShortDescription}"':
        '"{studyShortDescription}" 에 대한 타임을 셋하시오',
    'Set the "{inputTitle}" price for "{studyShortDescription}"':
        "{studyShortDescription}에 대한 {inputTitle} 가격 설정",
    'Set the price for "{studyShortDescription}"':
        '"{studyShortDescription}" 에 대한 프라이스를 셋하시오',
    "Add Symbol": "심볼 넣기",
    ...
    "Please enter the right date format yyyy-mm-dd":
        "올바른 날짜 포맷인 yyyy-mm-dd 으로 넣으십시오",
